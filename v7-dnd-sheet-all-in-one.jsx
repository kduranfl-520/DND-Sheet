...
window.DND_LIBRARY = {
 ...
 LIB_CATS: ["Race","Subrace","Class","Subclass","CL Feature","Background","Armor","Shield","Weapon","Spell","Scroll","Potion","Wand & Rod","Magic Item","Jewelry","Gem","Component","Tool","Deity","Faction","Companion","Equipment","Feat","Other"],
 LIB_SEED: [
 ...
 {id:"sp_tce_magnwave", title:"Magnify Gravity", category:"Spell",phb:false,tags:"1st,transmutation,TCE", desc:"The gravity in a 10-ft radius sphere centered on a point you can see within range increases.", notes:"Level: 1st. School: Transmutation. Cast: Act. Range: 60ft Components: V,S. Duration: 1 round. Save: CON. Damage: 2d8 force, speed halved. Upcast: +1d8 per sl..."},
 {id:"sp_tce_vertstrue", title:"Vortex Warp", category:"Spell",phb:false,tags:"2nd,conjuration,TCE", desc:"You magically twist space around another creature, teleporting it.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 90 ft. Components: V,S. Duration: Instantaneous. Save: CON (unwilling targets). Upcast: Range +30 ft per s..."},
 ...
 {id:"sp_tce_borealwind", title:"Boreal Wind", category:"Spell",phb:false,tags:"2nd,evocation,TCE", desc:"Icy wind blasts from you in a 15-ft cone.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: Self (15 ft cone). Components: V,S. Duration: Instantaneous. Save: STR. Damage: 3d8 cold. Upcast: +1d8 per s..."},
 {id:"sp_tce_borrowedknow", title:"Borrowed Knowledge", category:"Spell",phb:false,tags:"2nd,divination,TCE", desc:"You momentarily borrow the knowledge of a skill.", notes:"Level: 2nd. School: Divination. Cast: Act. Range: Self. Components: V,S,M. Duration: 1 hour. Effect: Prof in chosen skill for duration. Classes: Bard, Cleric..."},
 {id:"sp_tce_wrdofbloom", title:"Warding Wind", category:"Spell",phb:false,tags:"2nd,evocation,TCE", desc:"A strong wind (20 mph) blows around you in a 10-ft radius.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: Self. Components: V. Duration: Conc, 10 minutes. Effect: Deafened, extinguish small flames, difficult terrai..."},
 ...
 {id:"sp_firebolt", title:"Fire Bolt", category:"Spell", phb:true, tags:"cantrip,evocation,ranged,PHB", desc:"You hurl a mote of fire at a creature or object within range.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 120 ft. Components: V, S. Duration: Instantaneous. Attack/Save: Ranged spell attack. Damage: 1d10 fire (..."},
 {id:"sp_sacredflame", title:"Sacred Flame", category:"Spell", phb:true, tags:"cantrip,evocation,save,PHB", desc:"Flame-like radiance descends on a creature within range.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 60ft Components: V, S. Duration: Instantaneous. Attack/Save: DEX save. Damage: 1d8 radiant (2d8 at 5th, ..."},
 ...
 {id:"sp_vicmockery", title:"Vicious Mockery", category:"Spell", phb:true, tags:"cantrip,enchantment,save,PHB", desc:"You unleash a string of insults laced with subtle enchantments.", notes:"Level: Cantrip. School: Enchantment. Cast: Act. Range: 60ft Components: V. Duration: Instantaneous. Attack/Save: WIS save. Damage: 1d4 psychic + disadv on ne..."},
 {id:"sp_curewounds", title:"Cure Wounds", category:"Spell", phb:true, tags:"1st,evocation,healing,PHB", desc:"A creature you touch regains a number of HP = 1d8 + your spellcasting mod.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: Touch. Components: V, S. Duration: Instantaneous. Upcast: +1d8 per slot level above 1st. Classes: Bard, Cler..."},
 {id:"sp_magicmissile",title:"Magic Missile", category:"Spell", phb:true, tags:"1st,evocation,force,PHB", desc:"You create three glowing darts of magical force that automatically hit.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: 120 ft. Components: V, S. Duration: Instantaneous. Damage: 3 darts, each 1d4+1 force. Upcast: +1 dart per sl..."},
 {id:"sp_shield", title:"Shield", category:"Spell", phb:true, tags:"1st,abjuration,defense,PHB", desc:"An invisible barrier of magical force appears to protect you.", notes:"Level: 1st. School: Abjuration. Cast: Rxn (when hit or targeted by Magic Missile). Range: Self. Components: V, S. Duration: 1 round. Effect: +5 AC until star..."},
 {id:"sp_healingword", title:"Healing Word", category:"Spell", phb:true, tags:"1st,evocation,healing,PHB", desc:"A creature of your choice regains HP = 1d4 + your spellcasting mod.", notes:"Level: 1st. School: Evocation. Cast: BA. Range: 60ft Components: V. Duration: Instantaneous. Upcast: +1d4 per slot level above 1st. Classes: Bard, Cleric, Dr..."},
 {id:"sp_bless", title:"Bless", category:"Spell", phb:true, tags:"1st,enchantment,buff,PHB", desc:"You bless up to three creatures of your choice, adding 1d4 to atk rolls and saves.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 30ft Components: V, S, M (a sprinkling of holy water). Duration: Conc, up to 1 minute. Upcast: +1 creature..."},
 {id:"sp_charmper", title:"Charm Person", category:"Spell", phb:true, tags:"1st,enchantment,save,PHB", desc:"You attempt to charm a humanoid you can see within range.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 30ft Components: V, S. Duration: 1 hour. Attack/Save: WIS save. Upcast: +1 target per slot level above 1st..."},
 ...
 {id:"sp_sleep", title:"Sleep", category:"Spell", phb:true, tags:"1st,enchantment,save,PHB", desc:"This spell sends creatures into a magical slumber.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 90 ft. Components: V, S, M. Duration: 1 minute. Effect: 5d8 HP worth of creatures fall unconscious. Upcast..."},
 {id:"sp_holdbeast", title:"Hold Person", category:"Spell", phb:true, tags:"2nd,enchantment,save,PHB", desc:"Choose a humanoid within range. The target must succeed on a WIS save or be paralyzed.", notes:"Level: 2nd. School: Enchantment. Cast: Act. Range: 60ft Components: V, S, M. Duration: Conc, up to 1 minute. Attack/Save: WIS save. Upcast: +1 target per slo..."},
 ...
 {id:"sp_passnotrace", title:"Pass without Trace",category:"Spell",phb:true, tags:"2nd,abjuration,stealth,PHB", desc:"A veil of shadows and silence radiates from you, masking you and your companions.", notes:"Level: 2nd. School: Abjuration. Cast: Act. Range: Self. Components: V, S, M. Duration: Conc, up to 1 hour. Effect: You and creatures within 30 ft gain +10 to..."},
 {id:"sp_invisibility",title:"Invisibility", category:"Spell", phb:true, tags:"2nd,illusion,buff,PHB", desc:"A creature you touch becomes invisible until the spell ends.", notes:"Level: 2nd. School: Illusion. Cast: Act. Range: Touch. Components: V, S, M. Duration: Conc, up to 1 hour. Upcast: +1 creature per slot level above 2nd. Class..."},
 {id:"sp_fireball", title:"Fireball", category:"Spell", phb:true, tags:"3rd,evocation,fire,PHB", desc:"A bright streak flashes from your finger to a point you choose and then blossoms with a low roar.", notes:"Level: 3rd. School: Evocation. Cast: Act. Range: 150 ft. Components: V, S, M. Duration: Instantaneous. Attack/Save: DEX save. Damage: 8d6 fire (20-ft radius)..."},
 ...
 {id:"sp_counterspell",title:"Counterspell", category:"Spell", phb:true, tags:"3rd,abjuration,reaction,PHB", desc:"You attempt to interrupt a creature in the process of casting a spell.", notes:"Level: 3rd. School: Abjuration. Cast: Rxn. Range: 60ft Components: S. Duration: Instantaneous. Effect: Automatically stops spells of 3rd level or lower. High..."},
 {id:"sp_divination", title:"Divination", category:"Spell", phb:true, tags:"4th,divination,ritual,PHB", desc:"Your magic and an offering put you in contact with a god or a god's servants.", notes:"Level: 4th. School: Divination (Ritual). Cast: Act. Range: Self. Components: V, S, M (incense and a sacrificial offering). Duration: Instantaneous. Effect: A..."},
 {id:"sp_greaterrest", title:"Greater Restoration",category:"Spell",phb:true,tags:"5th,abjuration,healing,PHB", desc:"You imbue a creature with positive energy to undo a debilitating effect.", notes:"Level: 5th. School: Abjuration. Cast: Act. Range: Touch. Components: V, S, M (diamond dust worth 100 gp). Duration: Instantaneous. Effect: Removes charmed/pe..."},
 {id:"sp_masshealing", title:"Mass Cure Wounds", category:"Spell", phb:true, tags:"5th,evocation,healing,PHB", desc:"A wave of healing energy washes out from a point you choose, healing up to 6 creatures.", notes:"Level: 5th. School: Evocation. Cast: Act. Range: 60ft Components: V, S. Duration: Instantaneous. Heal: 3d8 + spellcasting mod each. Upcast: +1d8 per slot lev..."},

 {id:"sp_acidsplash", title:"Acid Splash", category:"Spell",phb:true,tags:"cantrip,conjuration,PHB", desc:"You hurl a bubble of acid. Choose one or two creatures within 5 ft of each other.", notes:"Level: Cantrip. School: Conjuration. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Save: DEX. Damage: 1d6 acid (2d6/5th, 3d6/11th, 4d6/17t..."},
 ...
 {id:"sp_chill", title:"Chill Touch", category:"Spell",phb:true,tags:"cantrip,necromancy,PHB", desc:"You create a ghostly skeletal hand that grabs at a creature. Prevents regaining HP until your next turn.", notes:"Level: Cantrip. School: Necromancy. Cast: Act. Range: 120 ft. Components: V,S. Duration: 1 round. Attack: Ranged spell attack. Damage: 1d8 necrotic (2d8/5th,..."},
 ...
 {id:"sp_producefm", title:"Produce Flame", category:"Spell",phb:true,tags:"cantrip,conjuration,PHB", desc:"A flickering flame appears in your hand. You can hurl it as a ranged spell attack.", notes:"Level: Cantrip. School: Conjuration. Cast: Act. Range: Self/30ft Components: V,S. Duration: 10 minutes. Attack: Ranged spell attack. Damage: 1d8 fire (2d8/5t..."},
 {id:"sp_rayoffrost", title:"Ray of Frost", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"A frigid beam of blue-white light streaks toward a creature within range. -10 ft speed on hit.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack. Damage: 1d8 cold (2d8/5th, 3..."},
 ...
 {id:"sp_shockgrsp", title:"Shocking Grasp", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"Lightning springs from your hand to deliver a shock to a creature. Adv if target wears metal armor.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: Touch. Components: V,S. Duration: Instantaneous. Attack: Melee spell attack. Damage: 1d8 lightning (2d8/..."},
 ...
 {id:"sp_starywisp", title:"Starry Wisp", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"You launch a mote of light at one creature within range. Marks the target, preventing hiding.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack. Damage: 1d8 radiant. Classes..."},
 ...
 {id:"sp_thornwhip", title:"Thorn Whip", category:"Spell",phb:true,tags:"cantrip,transmutation,PHB", desc:"You create a long vine-like whip covered in thorns that lashes out at your command.", notes:"Level: Cantrip. School: Transmutation. Cast: Act. Range: 30ft Components: V,S,M. Duration: Instantaneous. Attack: Melee spell attack. Damage: 1d6 piercing + ..."},
 {id:"sp_thunderclap", title:"Thunderclap", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"You create a burst of thunderous sound that can be heard up to 100 ft away.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: Self (5 ft). Components: S. Duration: Instantaneous. Save: CON. Damage: 1d6 thunder. Classes: Bard, Drui..."},
 {id:"sp_tolldeadcan", title:"Toll the Dead", category:"Spell",phb:true,tags:"cantrip,necromancy,PHB", desc:"You point at one creature you can see within range, and the sound of a dolorous bell fills the air.", notes:"Level: Cantrip. School: Necromancy. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Save: WIS. Damage: 1d8 necrotic (1d12 if missing HP). Cl..."},
 ...
 {id:"sp_absorb", title:"Absorb Elements", category:"Spell",phb:true,tags:"1st,abjuration,PHB", desc:"The spell captures some of the incoming energy, lessening its effect on you and storing it for your next melee attack.", notes:"Level: 1st. School: Abjuration. Cast: Rxn. Range: Self. Components: S. Duration: 1 round. Effect: Resist triggering damage type, add 1d6 to next melee attack..."},
 ...
 {id:"sp_anfrndsp", title:"Animal Friendship", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"This spell lets you convince a beast that you mean it no harm. Target beast must have INT 3 or less.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 30ft Components: V,S,M. Duration: 24 hours. Save: WIS. Upcast: +1 beast per slot above 1st. Classes: Bard,..."},
 {id:"sp_bane", title:"Bane", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"Up to three creatures of your choice must subtract 1d4 from atk rolls and saves.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 30ft Components: V,S,M. Duration: Conc, 1 minute. Save: CHA. Upcast: +1 creature per slot above 1st. Class..."},
 {id:"sp_burninghd", title:"Burning Hands", category:"Spell",phb:true,tags:"1st,evocation,fire,PHB", desc:"A thin sheet of flames shoots forth from your outstretched fingertips.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: Self (15 ft cone). Components: V,S. Duration: Instantaneous. Save: DEX. Damage: 3d6 fire. Upcast: +1d6 per s..."},
 {id:"sp_colordance", title:"Color Spray", category:"Spell",phb:true,tags:"1st,illusion,PHB", desc:"A dazzling array of flashing, colorful light springs from your hand. Blind creatures by total HP.", notes:"Level: 1st. School: Illusion. Cast: Act. Range: Self (15 ft cone). Components: V,S,M. Duration: 1 round. Effect: Blind 6d10 HP worth of creatures. Upcast: +2..."},
 {id:"sp_command1", title:"Command", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"You speak a one-word command to a creature you can see within range.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 60ft Components: V. Duration: 1 round. Save: WIS. Upcast: +1 creature per slot above 1st. Classes: Cleric,..."},
 ...
 {id:"sp_crorndes", title:"Create or Destroy Water",category:"Spell",phb:true,tags:"1st,transmutation,PHB", desc:"You either create or destroy water. Create 10 gallons in an open container or 30-ft cube of fog.", notes:"Level: 1st. School: Transmutation. Cast: Act. Range: 30ft Components: V,S,M. Duration: Instantaneous. Upcast: +10 gallons or +5 ft per slot above 1st. Classe..."},
 ...
 {id:"sp_fogcloud", title:"Fog Cloud", category:"Spell",phb:true,tags:"1st,conjuration,PHB", desc:"You create a 20-ft radius sphere of fog centered on a point within range.", notes:"Level: 1st. School: Conjuration. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 1 hour. Upcast: Radius +20 ft per slot above 1st. Classes: Druid,..."},
 ...
 {id:"sp_guidance1", title:"Guiding Bolt", category:"Spell",phb:true,tags:"1st,evocation,radiant,PHB", desc:"A flash of light streaks toward a creature. The next atk roll against the target has adv.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S. Duration: 1 round. Attack: Ranged spell attack. Damage: 4d6 radiant. Upcast: +1d6 p..."},
 {id:"sp_heroism", title:"Heroism", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"A willing creature you touch is imbued with bravery. Immune to frightened, gains temp HP = spellcasting mod each turn.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: Touch. Components: V,S. Duration: Conc, 1 minute. Upcast: +1 creature per slot above 1st. Classes: Bard, P..."},
 ...
 {id:"sp_illfavorite", title:"Inflict Wounds", category:"Spell",phb:true,tags:"1st,necromancy,PHB", desc:"Make a melee spell attack against a creature you can reach. On a hit, deal 3d10 necrotic damage.", notes:"Level: 1st. School: Necromancy. Cast: Act. Range: Touch. Components: V,S. Duration: Instantaneous. Attack: Melee spell attack. Damage: 3d10 necrotic. Upcast:..."},
 ...
 {id:"sp_longstrider", title:"Longstrider", category:"Spell",phb:true,tags:"1st,transmutation,PHB", desc:"You touch a creature. Its speed increases by 10 ft until the spell ends.", notes:"Level: 1st. School: Transmutation. Cast: Act. Range: Touch. Components: V,S,M. Duration: 1 hour. Upcast: +1 creature per slot above 1st. Classes: Bard, Druid..."},
 ...
 {id:"sp_searsmite", title:"Searing Smite", category:"Spell",phb:true,tags:"1st,evocation,PHB", desc:"The next time you hit a creature with a melee weapon attack, it burns with white-hot intensity.", notes:"Level: 1st. School: Evocation. Cast: BA. Range: Self. Components: V. Duration: Conc, 1 minute. Damage: 1d6 fire on hit, then 1d6 each turn (CON save). Upcast..."},
 ...
 {id:"sp_witchbolt", title:"Witch Bolt", category:"Spell",phb:true,tags:"1st,evocation,PHB", desc:"A beam of crackling lightning forms between you and a target. You can use your act to deal damage each turn.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: 30ft Components: V,S,M. Duration: Conc, 1 minute. Attack: Ranged spell attack. Damage: 1d12 lightning, repea..."},
 {id:"sp_wrthfulsmite", title:"Wrathful Smite", category:"Spell",phb:true,tags:"1st,evocation,PHB", desc:"The next time you hit with a melee weapon attack during the spell's duration, your strike channels divine wrath.", notes:"Level: 1st. School: Evocation. Cast: BA. Range: Self. Components: V. Duration: Conc, 1 minute. Damage: +1d6 psychic, target frightened on failed WIS save. Cl..."},
 ...
 {id:"sp_anmsg", title:"Animal Messenger", category:"Spell",phb:true,tags:"2nd,enchantment,ritual,PHB", desc:"By means of this spell, you use an animal to deliver a message.", notes:"Level: 2nd. School: Enchantment (Ritual). Cast: Act. Range: 30ft Components: V,S,M. Duration: 24 hours. Upcast: Duration x2 per slot above 2nd. Classes: Bard..."},
 ...
 {id:"sp_blinddeaf", title:"Blindness/Deafness", category:"Spell",phb:true,tags:"2nd,necromancy,PHB", desc:"You can blind or deafen a foe. Choose one creature within range. Save or be blinded or deafened.", notes:"Level: 2nd. School: Necromancy. Cast: Act. Range: 30ft Components: V. Duration: 1 minute. Save: CON. Upcast: +1 creature per slot above 2nd. Classes: Bard, C..."},
 ...
 {id:"sp_clouddag", title:"Cloud of Daggers", category:"Spell",phb:true,tags:"2nd,conjuration,PHB", desc:"You fill the air in a 5-ft cube with spinning daggers.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 minute. Damage: 4d4 slashing /turn. Upcast: +2d4 per slot above ..."},
 ...
 {id:"sp_enhanceab", title:"Enhance Ability", category:"Spell",phb:true,tags:"2nd,transmutation,PHB", desc:"You touch a creature and bestow upon it a magical enhancement.", notes:"Level: 2nd. School: Transmutation. Cast: Act. Range: Touch. Components: V,S,M. Duration: Conc, 1 hour. Upcast: +1 creature per slot above 2nd. Classes: Bard,..."},
 ...
 {id:"sp_flmsphr", title:"Flaming Sphere", category:"Spell",phb:true,tags:"2nd,conjuration,PHB", desc:"A 5-ft-diameter sphere of fire appears in an unoccupied space. It deals 2d6 fire damage.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Upcast: +1d6 per slot above 2nd. Classes: Dru..."},
 ...
 {id:"sp_moonbeam", title:"Moonbeam", category:"Spell",phb:true,tags:"2nd,evocation,PHB", desc:"A silvery beam of pale light shines down in a 5-ft radius cylinder.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: CON. Damage: 2d10 radiant. Upcast: +1d10 per slot..."},
 ...
 {id:"sp_scorchray", title:"Scorching Ray", category:"Spell",phb:true,tags:"2nd,evocation,fire,PHB", desc:"You create three rays of fire and hurl them at targets within range.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack per ray. Damage: 2d6 fire each..."},
 ...
 {id:"sp_shatter", title:"Shatter", category:"Spell",phb:true,tags:"2nd,evocation,PHB", desc:"A sudden loud ringing noise emanates from a point of your choice within range.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: 60ft Components: V,S,M. Duration: Instantaneous. Save: CON. Damage: 3d8 thunder. Upcast: +1d8 per slot above..."},
 ...
 {id:"sp_sumbeast", title:"Summon Beast", category:"Spell",phb:true,tags:"2nd,conjuration,PHB", desc:"You call forth a bestial spirit. It manifests in an unoccupied space that you can see within range.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 hour. Upcast: Creature improves at higher levels. Classes: Dru..."},
 {id:"sp_wardingbond", title:"Warding Bond", category:"Spell",phb:true,tags:"2nd,abjuration,PHB", desc:"This spell wards a willing creature you touch and creates a mystic connection between you.", notes:"Level: 2nd. School: Abjuration. Cast: Act. Range: Touch. Components: V,S,M (250 gp). Duration: 1 hour. Effect: +1 AC, +1 saves, resist all damage (but you ta..."},
 ...
 {id:"sp_calllight", title:"Call Lightning", category:"Spell",phb:true,tags:"3rd,conjuration,PHB", desc:"A storm cloud appears. Each turn, you can call down lightning to deal 3d10 lightning damage.", notes:"Level: 3rd. School: Conjuration. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 10 minutes. Save: DEX. Upcast: +1d10 per slot above 3rd. Classes:..."},
 {id:"sp_clairiov", title:"Clairvoyance", category:"Spell",phb:true,tags:"3rd,divination,PHB", desc:"You create an invisible sensor within range in a location familiar to you or in a location.", notes:"Level: 3rd. School: Divination. Cast: 10 minutes. Range: 1 mile. Components: V,S,M (100 gp). Duration: Conc, 10 minutes. Classes: Bard, Cleric, Sorcerer, Wiz..."},
 {id:"sp_conjanimals", title:"Conjure Animals", category:"Spell",phb:true,tags:"3rd,conjuration,PHB", desc:"You summon fey spirits that take the form of beasts.", notes:"Level: 3rd. School: Conjuration. Cast: Act. Range: 60ft Components: V,S. Duration: Conc, 1 hour. Upcast: More/stronger beasts per slot above 3rd. Classes: Dr..."},
 ...
 {id:"sp_fly3", title:"Fly", category:"Spell",phb:true,tags:"3rd,transmutation,PHB", desc:"You touch a willing creature. The target gains a flying speed of 60 ft for the duration.", notes:"Level: 3rd. School: Transmutation. Cast: Act. Range: Touch. Components: V,S,M. Duration: Conc, 10 minutes. Upcast: +1 creature per slot above 3rd. Classes: S..."},
 ...
 {id:"sp_vamptouch", title:"Vampiric Touch", category:"Spell",phb:true,tags:"3rd,necromancy,PHB", desc:"The touch of your shadow-wreathed hand can siphon life force from others. Deals 3d6 necrotic, heals half.", notes:"Level: 3rd. School: Necromancy. Cast: Act. Range: Self. Components: V,S. Duration: Conc, 1 minute. Attack: Melee spell attack. Damage: 3d6 necrotic, heal hal..."},
 ...
 {id:"sp_windwall", title:"Wind Wall", category:"Spell",phb:true,tags:"3rd,evocation,PHB", desc:"A wall of strong wind rises from the ground at a point you choose within range.", notes:"Level: 3rd. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: STR. Damage: 3d8 bludgeoning. Classes: Druid, Ran..."},
 ...
 {id:"sp_banishment", title:"Banishment", category:"Spell",phb:true,tags:"4th,abjuration,PHB", desc:"You attempt to send one creature you can see within range to another plane of existence.", notes:"Level: 4th. School: Abjuration. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 minute. Save: CHA. Upcast: +1 creature per slot above 4th. Classe..."},
 {id:"sp_blight", title:"Blight", category:"Spell",phb:true,tags:"4th,necromancy,PHB", desc:"Necromantic energy washes over a creature, sapping its vitality.", notes:"Level: 4th. School: Necromancy. Cast: Act. Range: 30ft Components: V,S. Duration: Instantaneous. Save: CON. Damage: 8d8 necrotic. Upcast: +1d8 per slot above..."},
 {id:"sp_confuse4", title:"Confusion", category:"Spell",phb:true,tags:"4th,enchantment,PHB", desc:"This spell assaults and twists creatures' minds, spawning delusions and provoking uncontrolled act.", notes:"Level: 4th. School: Enchantment. Cast: Act. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: WIS. Upcast: +5 ft radius per slot above 4th. Cl..."},
 ...
 {id:"sp_evardblt", title:"Evard's Black Tentacles",category:"Spell",phb:true,tags:"4th,conjuration,PHB", desc:"Squirming black tentacles fill a 20-ft square on ground you can see within range.", notes:"Level: 4th. School: Conjuration. Cast: Act. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Damage: 3d6 bludgeoning /turn, restrained. ..."},
 ...
 {id:"sp_grdnfaith", title:"Guardian of Faith", category:"Spell",phb:true,tags:"4th,conjuration,PHB", desc:"A Large spectral guardian appears in an unoccupied space of your choice within range.", notes:"Level: 4th. School: Conjuration. Cast: Act. Range: 30ft Components: V. Duration: 8 hours. Damage: 20 radiant to creatures that move within 10 ft. Classes: Cl..."},
 ...
 {id:"sp_icestorm", title:"Ice Storm", category:"Spell",phb:true,tags:"4th,evocation,cold,PHB", desc:"A hail of rock-hard ice pounds to the ground in a 20-ft radius 40-ft high cylinder.", notes:"Level: 4th. School: Evocation. Cast: Act. Range: 300 ft. Components: V,S,M. Duration: Instantaneous. Save: DEX. Damage: 2d8 bludgeoning + 4d6 cold. Upcast: +..."},
 ...
 {id:"sp_stoneskin", title:"Stoneskin", category:"Spell",phb:true,tags:"4th,abjuration,PHB", desc:"This spell turns the flesh of a willing creature as hard as stone. Resist nonmagical bludgeoning, piercing, and slashing.", notes:"Level: 4th. School: Abjuration. Cast: Act. Range: Touch. Components: V,S,M (diamond dust 100 gp). Duration: Conc, 1 hour. Classes: Druid, Ranger, Sorcerer, W..."},
 {id:"sp_wallfire", title:"Wall of Fire", category:"Spell",phb:true,tags:"4th,evocation,fire,PHB", desc:"You create a wall of fire on a solid surface within range. The wall is opaque and lasts for the duration.", notes:"Level: 4th. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Damage: 5d8 fire. Upcast: +1d8 per slot abov..."},
 {id:"sp_animobj", title:"Animate Objects", category:"Spell",phb:true,tags:"5th,transmutation,PHB", desc:"Objects come to life at your command. Choose up to ten nonmagical objects within range.", notes:"Level: 5th. School: Transmutation. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 1 minute. Upcast: +2 objects per slot above 5th. Classes: Bard,..."},
 ...
 {id:"sp_cloudkill", title:"Cloudkill", category:"Spell",phb:true,tags:"5th,conjuration,PHB", desc:"You create a 20-ft radius sphere of poisonous, yellow-green fog.", notes:"Level: 5th. School: Conjuration. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 10 minutes. Save: CON. Damage: 5d8 poison /turn. Upcast: +1d8 per..."},
 {id:"sp_conenecold", title:"Cone of Cold", category:"Spell",phb:true,tags:"5th,evocation,cold,PHB", desc:"A blast of cold air erupts from your hands in a 60-ft cone.", notes:"Level: 5th. School: Evocation. Cast: Act. Range: Self (60 ft cone). Components: V,S,M. Duration: Instantaneous. Save: CON. Damage: 8d8 cold. Upcast: +1d8 per..."},
 ...
 {id:"sp_contelm", title:"Conjure Elemental", category:"Spell",phb:true,tags:"5th,conjuration,PHB", desc:"You call forth an elemental servant to serve you.", notes:"Level: 5th. School: Conjuration. Cast: 1 minute. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 hour. Upcast: Higher CR per slot above 5th. Classes: Drui..."},
 ...
 {id:"sp_creation5", title:"Creation", category:"Spell",phb:true,tags:"5th,illusion,PHB", desc:"You pull wisps of shadow material from the Shadowfell to create a nonliving object of vegetable matter.", notes:"Level: 5th. School: Illusion. Cast: 1 minute. Range: 30ft Components: V,S,M. Duration: Special. Upcast: More materials per slot above 5th. Classes: Sorcerer,..."},
 ...
 {id:"sp_flmstrike", title:"Flame Strike", category:"Spell",phb:true,tags:"5th,evocation,fire,PHB", desc:"A vertical column of divine fire roars down from the heavens in a 10-ft radius 40-ft high cylinder.", notes:"Level: 5th. School: Evocation. Cast: Act. Range: 60ft Components: V,S,M. Duration: Instantaneous. Save: DEX. Damage: 4d6 fire + 4d6 radiant. Upcast: +1d6 eac..."},
 ...
 {id:"sp_holdmon", title:"Hold Monster", category:"Spell",phb:true,tags:"5th,enchantment,PHB", desc:"Choose a creature that you can see within range. The target must succeed on a WIS save or be paralyzed.", notes:"Level: 5th. School: Enchantment. Cast: Act. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: WIS. Upcast: +1 creature per slot above 5th. Cla..."},
 {id:"sp_inscplague", title:"Insect Plague", category:"Spell",phb:true,tags:"5th,conjuration,PHB", desc:"Swarming locusts fill a 20-ft radius sphere centered on a point you choose within range.", notes:"Level: 5th. School: Conjuration. Cast: Act. Range: 300 ft. Components: V,S,M. Duration: Conc, 10 minutes. Save: CON. Damage: 4d10 piercing. Upcast: +1d10 per..."},
 ...
 {id:"ar_bracers",title:"Bracers of Defense",category:"Magic Item",phb:true,tags:"magic,armor,PHB",desc:"+2 AC when unarmored and no shield.",notes:"Rarity: Rare. Attune: Yes."},
 {id:"ar_robe_prot",title:"Robe of Protection",category:"Magic Item",phb:true,tags:"magic,armor,PHB",desc:"+1 AC and all saves.",notes:"Rarity: Uncommon. Attune: Yes. Spellcaster only."},
 ...
 {id:"pd_crown_disgust",title:"Crown of Disgust",category:"Spell",phb:false,tags:"psionic,avatar,mystic,UA", desc:"Flood a creature with emotions of disgust.", notes:"Avatar. Focus: 5ft difficult terrain for enemies. Options: Eye of Horror (1-7p: 1d6/p+can't approach), Wall of Repulsion (3p conc10m: WIS save to pass), Visi..."},
 {id:"pd_crown_rage",title:"Crown of Rage",category:"Spell",phb:false,tags:"psionic,avatar,mystic,UA", desc:"Place pure fury in a creature's mind.", notes:"Avatar. Focus: Enemies within 5ft disadv atk vs others. Options: Primal Fury (1-7p: 1d6/p+charge enemy CHA save), Fighting Words (2p conc10m: target attacks ..."},
 {id:"pd_mantle_command",title:"Mantle of Command",category:"Spell",phb:false,tags:"psionic,avatar,mystic,UA", desc:"Exert an aura of authority, enhancing ally coordination.", notes:"Avatar. Focus: Rxn to move ally half speed when you don't move. Options: Coordinated Move (2p: 5 allies move half speed), Commander's Sight (2p conc1r: adv a..."},
 {id:"pd_mantle_courage",title:"Mantle of Courage",category:"Spell",phb:false,tags:"psionic,avatar,mystic,UA", desc:"Radiate confidence, granting allies adv vs fear.", notes:"Avatar. Focus: Adv vs frightened within 10ft. Options: Incite Courage (2p: remove frightened from 6 creatures), Aura of Victory (1-7p conc10m: temp HP=2x psi..."},
 {id:"pd_mantle_fear",title:"Mantle of Fear",category:"Spell",phb:false,tags:"psionic,avatar,mystic,UA", desc:"Radiate terror to your enemies.", notes:"Avatar. Focus: Adv Intimidation. Options: Incite Fear (2p conc1m: frighten 1 WIS save), Unsettling Aura (3p conc1h: extra move cost toward you), Incite Panic..."},
 {id:"pd_mantle_fury",title:"Mantle of Fury",category:"Spell",phb:false,tags:"psionic,avatar,mystic,UA", desc:"Unleash primal fury, catching allies in bloodthirst.", notes:"Avatar. Focus: +5ft speed to you+nearby allies each turn. Options: Incite Fury (2p conc1m: 3 allies +d4 melee dmg), Mindless Charge (2p: 3 creatures charge n..."},
 {id:"pd_mantle_joy",title:"Mantle of Joy",category:"Spell",phb:false,tags:"psionic,avatar,mystic,UA", desc:"Radiate joy, bringing hope and comfort to creatures around you.", notes:"Avatar. Focus: Adv Persuasion. Options: Soothing Presence (1-7p: 3 temp HP/p to 3 creatures), Comforting Aura (2p conc1m: d4 on saves for 3 allies), Aura of ..."},
 {id:"pd_mantle_awe",title:"Mantle of Awe",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Manipulate others with psionic charm.", notes:"Awakened. Focus: +half INT mod to CHA checks. Options: Charming Presence (1-7p: 2d8/p HP of creatures charmed 10min), Center of Attention (2p conc1m: 1 creat..."},
 {id:"pd_aura_sight",title:"Aura Sight",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"See the energy surrounding all creatures.", notes:"Awakened. Focus: Adv Insight. Options: Assess Foe (2p: learn HP+resists), Read Moods (2p: one-word emotion of 6 creatures), View Aura (3p conc1h: ongoing HP+..."},
 {id:"pd_intellect_fortress",title:"Intellect Fortress",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Forge a wall of psionic energy around your mind.", notes:"Awakened. Focus: Psychic resist. Options: Psychic Backlash (2p: disadv on atk vs you+2d10 psychic if hits), Psychic Parry (1-7p: +1/p to INT/WIS/CHA saves as..."},
 {id:"pd_precognition",title:"Precognition",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Weave a string of probabilities for extraordinary insights.", notes:"Awakened. Focus: Adv initiative. Options: Precognitive Hunch (2p conc1m: d4 to all atk/save/check), All-Around Sight (3p: rxn impose disadv on atk vs you), D..."},
 {id:"pd_psychic_assault",title:"Psychic Assault",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Wield your mind like a weapon, unleashing psionic energy.", notes:"Awakened. Focus: +2 dmg to talents dealing psychic. Options: Psionic Blast (1-7p: 1d8/p psychic 60ft), Ego Whip (3p: 3d8 psychic INT save+limited acts), Id I..."},
 {id:"pd_psychic_disruption",title:"Psychic Disruption",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Create psychic static that disrupts clear thinking.", notes:"Awakened. Focus: Adv Deception. Options: Distracting Haze (1-7p conc1m: 1d10/p+vision 10ft INT save), Daze (3p: incapacitate til end of next turn INT save), ..."},
 {id:"pd_psychic_inquisition",title:"Psychic Inquisition",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Reach into a creature's mind to uncover information.", notes:"Awakened. Focus: Know when telepathic contact is lying. Options: Hammer of Inquisition (1-7p: 1d10/p+disadv next WIS save INT save), Forceful Query (2p: yes/..."},
 {id:"pd_psychic_phantoms",title:"Psychic Phantoms",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Cause a creature to perceive false things.", notes:"Awakened. Focus: Adv Deception. Options: Distracting Figment (1-7p: 1d10/p+no rxns+adv melee vs it), Phantom Foe (3p conc1m: adjacent horror+no rxns+1d8/turn..."},
 {id:"pd_telepathic_contact",title:"Telepathic Contact",category:"Spell",phb:false,tags:"psionic,awakened,mystic,UA", desc:"Control other creatures by substituting your will.", notes:"Awakened. Focus: Telepathy with 6 creatures at once. Options: Exacting Query (2p: truthful answer INT save), Occluded Mind (2p: believe 10-word statement INT..."},
 {id:"pd_adaptive_body",title:"Adaptive Body",category:"Spell",phb:false,tags:"psionic,immortal,mystic,UA", desc:"Alter your body to withstand punishing environments.", notes:"Immortal. Focus: No need to eat/breathe/sleep; light activity = LR. Options: Environmental Adaptation (2p: ignore extreme heat/cold 1h), Adaptive Shield (3p:..."},
 {id:"pd_bestial_form",title:"Bestial Form",category:"Spell",phb:false,tags:"psionic,immortal,mystic,UA", desc:"Transform your body, gaining traits of different beasts.", notes:"Immortal. Focus: Adv Animal Handling. Bestial Claws (1-7p: 1d10/p slash melee). Bestial Transformation (BA, 1h): Amphibious (2p), Climbing (2p: climb=walk), ..."},
 ...
 {id:"pd_celerity",title:"Celerity",category:"Spell",phb:false,tags:"psionic,immortal,mystic,UA", desc:"Channel psionic power to hone reflexes and agility.", notes:"Immortal. Focus: +10ft speed. Options: Rapid Step (1-7p: +10ft/p speed til end of turn), Agile Defense (2p: Dodge as BA), Blur of Motion (2p: invisible durin..."},
 ...
 {id:"pd_diminution",title:"Diminution",category:"Spell",phb:false,tags:"psionic,immortal,mystic,UA", desc:"Reduce your size drastically without surrendering might.", notes:"Immortal. Focus: Adv Stealth. Options: Miniature Form (2p conc10m: Tiny++5 Stealth+fit 6in gaps), Toppling Shift (2p: STR save or prone), Sudden Shift (5p: r..."},
 ...
 {id:"pd_iron_durability",title:"Iron Durability",category:"Spell",phb:false,tags:"psionic,immortal,mystic,UA", desc:"Transform your body into living metal.", notes:"Immortal. Focus: +1 AC. Options: Iron Hide (1-7p: rxn +1 AC/p vs triggering atk), Steel Hide (2p: resist B/P/S til end of next turn BA), Iron Resist (7p conc..."},
 {id:"pd_psionic_restoration",title:"Psionic Restoration",category:"Spell",phb:false,tags:"psionic,immortal,mystic,UA", desc:"Wield psionic energy to cure wounds and restore health.", notes:"Immortal. Focus: BA to stabilize creature at 0 HP. Options: Mend Wounds (1-7p: 1d8 HP/p on touch), Restore Health (3p: remove blinded/deafened/paralyzed/pois..."},
 {id:"pd_psionic_weapon",title:"Psionic Weapon",category:"Spell",phb:false,tags:"psionic,immortal,mystic,UA", desc:"Channel psionic energy into attacks, converting damage to psychic.", notes:"Immortal. Focus: Chosen weapon deals psychic+magical. Options: Ethereal Weapon (1p: next atk ignores AC, DEX save for half), Lethal Strike (1-7p: +1d10/p psy..."},
 {id:"pd_nomadic_arrow",title:"Nomadic Arrow",category:"Spell",phb:false,tags:"psionic,nomad,mystic,UA", desc:"Imbue a ranged weapon with sentience to find its mark.", notes:"Nomad. Focus: Ignore disadv on ranged atk (no adv either). Options: Speed Dart (1-7p: +1d10/p psychic on next ranged hit BA), Seeking Missile (2p: rxn repeat..."},
 ...
 {id:"pd_nomadic_mind",title:"Nomadic Mind",category:"Spell",phb:false,tags:"psionic,nomad,mystic,UA", desc:"Dispatch part of your psyche into the noosphere.", notes:"Nomad. Focus: Choose skill/tool prof or read/write language while focused. Options: Wandering Mind (2-6p conc10m: gain 1 skill/2p for 1h), Find Creature (2p ..."},
 {id:"pd_nomadic_step",title:"Nomadic Step",category:"Spell",phb:false,tags:"psionic,nomad,mystic,UA", desc:"Twist intraplanar pathways for instantaneous travel.", notes:"Nomad. Focus: +10ft speed after teleporting. Options: Step of Dozen Paces (1-7p: teleport 20ft/p BA), Nomadic Anchor (1p: create teleport anchor 8h), Defensi..."},
 {id:"pd_third_eye",title:"Third Eye",category:"Spell",phb:false,tags:"psionic,nomad,mystic,UA", desc:"Create a third psychic eye channeling knowledge to you.", notes:"Nomad. Focus: Darkvision 60ft (or +10ft). Options: Tremorsense (2p conc1m: tremorsense 30ft), Unwavering Eye (2p: adv WIS checks 1min), Piercing Sight (3p co..."},
 {id:"pd_mastery_air",title:"Mastery of Air",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Become one with the power of elemental air.", notes:"Wu Jen. Focus: No fall dmg, ignore difficult terrain. Options: Wind Step (1-7p: fly 20ft/p), Wind Stream (1-7p: 30ft line 1d8/p bludg+prone STR save), Cloak ..."},
 {id:"pd_mastery_fire",title:"Mastery of Fire",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Align your mind with elemental fire.", notes:"Wu Jen. Focus: Fire resist++2 fire dmg rolls. Options: Combustion (1-7p conc1m: 1d10/p fire+1d6/turn CON save), Rolling Flame (3p conc1m: 20x20ft fire 5dmg/t..."},
 {id:"pd_mastery_force",title:"Mastery of Force",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Transform potential energy into actual force.", notes:"Wu Jen. Focus: Adv STR checks. Options: Push (1-7p: 1d8/p force+push 5ft/p STR save), Move (2-7p: telekinetically move up to 1000 lbs), Inertial Armor (2p: A..."},
 {id:"pd_mastery_ice",title:"Mastery of Ice",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Master the power of ice.", notes:"Wu Jen. Focus: Cold resist. Options: Ice Spike (1-7p: 1d8/p cold+halve speed DEX save), Ice Sheet (2p: 20ft radius icy terrain 10min), Frozen Sanctuary (3p: ..."},
 {id:"pd_mastery_light",title:"Mastery of Light and Darkness",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Claim dominion over light and darkness.", notes:"Wu Jen. Focus: Darkness within 30ft has no effect on your vision. Options: Darkness (1-7p: 10ft radius/p magical darkness), Light (2p conc1m: object radiates..."},
 {id:"pd_mastery_water",title:"Mastery of Water",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Become one with elemental water.", notes:"Wu Jen. Focus: Swim speed=walk+breathe underwater. Options: Desiccate (1-7p: 1d10/p necrotic CON save), Watery Grasp (2p: wave 2d6+prone+pull 10ft STR save),..."},
 {id:"pd_mastery_weather",title:"Mastery of Weather",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Reshape storms to serve your needs.", notes:"Wu Jen. Focus: Lightning+thunder resist. Options: Cloud Steps (1-7p conc10m: cloud staircase 20ft/p), Hungry Lightning (1-7p: 1d8/p lightning DEX save, disad..."},
 {id:"pd_mastery_wood",title:"Mastery of Wood and Earth",category:"Spell",phb:false,tags:"psionic,wujen,mystic,UA", desc:"Attune your mind to seize control of wood and earth.", notes:"Wu Jen. Focus: +1 AC. Options: Animate Weapon (1-7p: one-handed weapon atk+1d10/p force), Warp Weapon (2p: weapon unusable STR save), Warp Armor (3p: reduce ..."},
 ...
 {id:"sr_duergar", title:"Gray Dwarf (Duergar)", category:"Subrace", phb:false, tags:"dwarf,underdark,psionic,SCAG", desc:"The gray dwarves, or duergar, live deep in the Underdark. After centuries of toil and subjugation by mind flayers, they have developed unique psionic abilities.", notes:"Parent: Dwarf. Ability Score Increase: +1 STR. Superior Darkvision 120 ft. Duergar Resilience (adv on saves vs illusions, charmed, paralyzed). Duergar Magic: Enlarge (self, 1/LR) and Invisibility (1/LR) at 3rd level. Sunlight Sensitivity (disadv on attack rolls and Perception in sunlight). Speed: 25 ft."},
 {id:"sr_deepgnome", title:"Deep Gnome (Svirfneblin)", category:"Subrace", phb:false, tags:"gnome,underdark,stealth,SCAG", desc:"Deep gnomes, or svirfneblin, live deep in the Underdark, carving out enclaves in dangerous subterranean places.", notes:"Parent: Gnome. Ability Score Increase: +1 DEX. Superior Darkvision 120 ft. Stone Camouflage (adv on Stealth checks in rocky terrain). Extra Language: Undercommon. Source: Mordenkainen Presents: Monsters of the Multiverse (updated from Elemental Evil Player's Companion)."},
