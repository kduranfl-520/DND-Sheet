...
window.DND_LIBRARY = {
 ...
 LIB_CATS: ["Race","Subrace","Class","Subclass","CL Feature","Background","Armor","Shield","Weapon","Equipment","Tools & Kits","Magic Item","Spell","Scroll","Potion","Wand & Rod","Jewelry","Gem","Component","Deity","Faction","Companion","Feat","Other"],
 LIB_SEED: [
 ...
 {id:"mi_bag_holding",title:"Bag of Holding",category:"Magic Item",phb:false,tags:"wondrous,utility,DMG",desc:"Interior larger than outside. 500 lbs / 64 cu ft. Weighs 15 lbs.",notes:"Rarity: Uncommon. No attune. Retrieval: act. Placing inside another extradimensional space: 50% chance sucks all to Astral Plane."},
 ...
 {id:"mi_pearl_power",title:"Pearl of Power",category:"Magic Item",phb:false,tags:"wondrous,spellcasting,DMG",desc:"1/day: Regain one slot of 3rd level or lower.",notes:"Rarity: Uncommon. Attune: spellcaster. Recharge: dawn."},
 {id:"mi_tce_bloodwell",title:"Bloodwell Vial",category:"Magic Item",phb:false,tags:"magic item,sorcerer,DMG",desc:"+1/+2/+3 spell atk and save DC. Recover 5 sorcery points 1/dawn.",notes:"Rarity: Uncommon/Rare/Very Rare (TCE). Attune: Sorcerer."},
 {id:"mi_tce_devotee",title:"Devotee's Censer",category:"Magic Item",phb:false,tags:"magic item,cleric,DMG",desc:"+2 flail + holy symbol. 5 charges: Channel Divinity on SR.",notes:"Rarity: Rare (TCE). Attune: cleric/paladin."},
 {id:"mi_tce_atlas",title:"Atlas of Endless Horizons",category:"Magic Item",phb:false,tags:"magic item,wizard,DMG",desc:"+2 spell atk/save DC. 3 charges: planar travel spells.",notes:"Rarity: Very Rare (TCE). Attune: Wizard."},
 {id:"mi_tce_cauldron",title:"Cauldron of Rebirth",category:"Magic Item",phb:false,tags:"magic item,druid,DMG",desc:"1/LR: Wildshape into cauldron; revive a creature as True Resurrection.",notes:"Rarity: Very Rare (TCE). Attune: druid/warlock."},
 ...
 {id:"ar_robe_prot",title:"Robe of Protection",category:"Magic Item",phb:false,tags:"magic,armor,DMG",desc:"+1 AC and all saves.",notes:"Rarity: Uncommon. Attune: Yes. Spellcaster only."},
 ...
 {id:"mi_necklace_adapt",title:"Necklace of Adaptation",category:"Magic Item",phb:false,tags:"wondrous,utility,DMG",desc:"Breathe in any environment. Adv on inhaled hazard saves.",notes:"Rarity: Uncommon. Attune: Yes. (Also in Jewelry)"},
 {id:"mi_circlet_blasting",title:"Circlet of Blasting",category:"Magic Item",phb:false,tags:"wondrous,DMG",desc:"1/day: cast Scorching Ray (atk bonus +5).",notes:"Rarity: Uncommon. No attune. Recharge: dawn."},
...
const BLANK = {
 ...
 hp:{max:0,current:1,temp:0},
  wearing_head:[],wearing_neck:[],wearing_shoulders:[],wearing_body:[],wearing_arms:[],wearing_hands:[],wearing_hips:[],wearing_feet:[],
 ac:10, speed:30,
...
function App() {
 ...
 const [openShield, setOpenShield] = useState(false);
  const [openWearing, setOpenWearing] = useState(false);
 ...
 onClick={()=>setCharSaving(p=>{const a=[...(p.weaponItems||[])];a.splice(idx,1);return {...p,weaponItems:a};})}>✕</button>
            ...
            <SecHead icon="👘" title="Wearing"/>
            <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"6px 10px",background:"var(--surface)",borderBottom:openWearing?"1px solid var(--divider)":"none",borderRadius:openWearing?"8px 8px 0 0":"8px"}}>
                <div style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",flex:1}} onClick={()=>setOpenWearing(o=>!o)}>
                  <span style={{fontSize:12}}>👘</span>
                  <span style={{fontSize:10,fontWeight:700,letterSpacing:".07em",textTransform:"uppercase",color:"var(--muted)"}}>Wearing</span>
                </div>
                <span style={{fontSize:10,color:"var(--muted)",cursor:"pointer"}} onClick={()=>setOpenWearing(o=>!o)}>{openWearing?"▲":"▼"}</span>
              </div>
              {openWearing&&<div style={{padding:"8px 12px",display:"flex",flexDirection:"column",gap:6}}>
                {[
                  {label:"Head",key:"wearing_head",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("helm")||e.title.toLowerCase().includes("hat")||e.title.toLowerCase().includes("head")||e.title.toLowerCase().includes("crown")||e.title.toLowerCase().includes("circlet")||e.title.toLowerCase().includes("hood")},
                  {label:"Neck",key:"wearing_neck",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("necklace")||e.title.toLowerCase().includes("amulet")||e.title.toLowerCase().includes("neck")||e.title.toLowerCase().includes("pendant")||e.title.toLowerCase().includes("medallion")||e.title.toLowerCase().includes("periapt")||e.title.toLowerCase().includes("scarab")},
                  {label:"Shoulders",key:"wearing_shoulders",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("shoulder")||e.title.toLowerCase().includes("mantle")||e.title.toLowerCase().includes("pauldron")||e.title.toLowerCase().includes("cloak")||e.title.toLowerCase().includes("cape")},
                  {label:"Body",key:"wearing_body",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("robe")},
                  {label:"Arms",key:"wearing_arms",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("arm")||e.title.toLowerCase().includes("bracer")||e.title.toLowerCase().includes("sleeve")||e.title.toLowerCase().includes("gauntlet")||e.title.toLowerCase().includes("vambrace"),hand:true},
                  {label:"Hands",key:"wearing_hands",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("glove")||e.title.toLowerCase().includes("gauntlet")||e.title.toLowerCase().includes("hand")||e.title.toLowerCase().includes("ring")||e.title.toLowerCase().includes("mitten"),hand:true},
                  {label:"Hips",key:"wearing_hips",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("belt")||e.title.toLowerCase().includes("girdle")||e.title.toLowerCase().includes("hip")},
                  {label:"Feet",key:"wearing_feet",cats:["Magic Item"],filter:(e)=>e.title.toLowerCase().includes("boot")||e.title.toLowerCase().includes("slipper")||e.title.toLowerCase().includes("shoe")||e.title.toLowerCase().includes("feet")||e.title.toLowerCase().includes("sandal")},
                ].map(({label,key,cats,filter,hand})=>{
                  const opts = libEntries.filter(e=>cats.includes(e.category)&&filter(e)).sort((a,b)=>a.title.localeCompare(b.title));
                  return (
                    <div key={key} style={{display:"flex",flexDirection:"column",gap:3}}>
                      <div style={{display:"flex",alignItems:"center",gap:4}}>
                        <span style={{fontSize:9,fontWeight:700,letterSpacing:".07em",textTransform:"uppercase",color:"var(--muted)",minWidth:62,flexShrink:0}}>{label}</span>
                        <button style={{fontSize:9,fontWeight:700,padding:"1px 7px",borderRadius:5,border:"1px solid rgba(99,102,241,0.3)",background:"rgba(99,102,241,0.08)",color:"var(--accent)",cursor:"pointer",flexShrink:0}}
                          onClick={()=>setF(key,[...(char[key]||[]),{name:"",eq:false,at:false,hand:""}])}>+ Add</button>
                      </div>
                      {(char[key]||[]).map((item,itemIdx)=>{
                        ...
                        const updateItem = (patch)=>setCharSaving(p=>{
                          const arr=[...(p[key]||[])];
                          arr[itemIdx]={name:itemName,eq:itemEq,at:itemAt,hand:itemHand,...patch};
                          return {...p,[key]:arr};
                        });
                        const entry = itemName?libEntries.find(e=>e.title===itemName&&cats.includes(e.category)):null;
                        const needsAttune = entry&&(entry.notes||"").toLowerCase().includes("attune: yes");
                        const hands = ["","RH","LH","BH"];
                        const handColors = {RH:"#2563eb",LH:"#7c3aed",BH:"#0891b2"};
                        return (
                          <div key={itemIdx} style={{display:"flex",gap:4,alignItems:"center"}}>
                            ...
                            {hand&&<button title={itemHand||"No hand"}
                              style={{fontSize:9,fontWeight:800,padding:"2px 5px",borderRadius:5,border:"1px solid",flexShrink:0,cursor:"pointer",minWidth:28,
                                background:itemHand?"rgba(99,102,241,0.08)":"var(--input)",
                                borderColor:itemHand?"rgba(99,102,241,0.3)":"var(--border)",
                                color:itemHand?handColors[itemHand]:"var(--muted)"}}
                              onClick={()=>updateItem({hand:hands[(hands.indexOf(itemHand)+1)%hands.length]})}>{itemHand||"—"}</button>}
                            <select className="gi gi-sm" style={{flex:1,color:itemName?"var(--text)":"var(--subtle)"}}
                              value={itemName||""} onChange={e=>updateItem({name:e.target.value})}>
                              <option value="">— None —</option>
                              {opts.map(e=><option key={e.id} value={e.title}>{e.title}</option>)}
                            </select>
                            {itemName&&<button title={"View: "+itemName}
                              style={{fontSize:9,padding:"2px 6px",borderRadius:5,border:"1px solid rgba(99,102,241,0.3)",background:"rgba(99,102,241,0.08)",color:"var(--accent)",cursor:"pointer",flexShrink:0}}
                              onClick={()=>{
                                const e=libEntries.find(ex=>ex.title===itemName&&cats.includes(ex.category));
                                if(e){setLibModal(e);}
                              }}>ℹ</button>}
                            <button style={{fontSize:9,padding:"2px 6px",borderRadius:5,border:"1px solid var(--border)",background:"var(--input)",color:"var(--muted)",cursor:"pointer",flexShrink:0}}
                              onClick={()=>setCharSaving(p=>{const arr=[...(p[key]||[])];arr.splice(itemIdx,1);return {...p,[key]:arr};})}>✕</button>
                          </div>
                        );
                      })}
                      {wearingInfo&&(char[key]||[]).some(i=>(typeof i==="object"?i.name:i)===wearingInfo.title)&&(
                        <div style={{fontSize:11,background:"var(--surface)",border:"1px solid var(--divider)",borderRadius:6,padding:"6px 10px",color:"var(--text)",lineHeight:1.5}}>
                          <div style={{fontWeight:700,marginBottom:2}}>{wearingInfo.title}</div>
                          <div style={{color:"var(--muted)",marginBottom:3}}>{wearingInfo.desc}</div>
                          {wearingInfo.notes&&<div style={{fontSize:10,color:"var(--subtle)"}}>{wearingInfo.notes}</div>}
                        </div>
                      )}
                    </div>
                  );
...
const LIB_CATS = window.DND_LIBRARY?.LIB_CATS || ["Race","Subrace","Class","Subclass","CL Feature","Background","Armor","Shield","Weapon","Equipment","Tools & Kits","Magic Item","Spell","Scroll","Potion","Wand & Rod","Jewelry","Gem","Component","Deity","Faction","Companion","Feat","Other"];
