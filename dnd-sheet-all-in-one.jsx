...
function App() {
 ...
 title={hdrOpen ? "Collapse header" : "Expand header"}>
        ...
        <button
          ...
          onClick={()=>setCharSaving(p=>({...p, actionUsed:false, bonusActionUsed:false, reactionUsed:false, moveUsed:0}))}
          style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:1,width:40,height:40,borderRadius:12,background:"rgba(239,68,68,0.07)",border:"1px solid rgba(239,68,68,0.25)",color:"var(--red)",cursor:"pointer",flexShrink:0,transition:"all .15s",fontFamily:"inherit"}}>
          <span style={{fontSize:16,lineHeight:1}}>↺</span>
          <span style={{fontSize:7,fontWeight:700,letterSpacing:".05em",textTransform:"uppercase"}}>Turn</span>
        </button>
      </div>
 ...
 r.readAsDataURL(file);
        ...
        {tab==="rounds" && (
          <div className="panel">
            {/* Action toggles - vertical stack with side space */}
            <div style={{display:"flex",flexDirection:"column",gap:6,marginBottom:8}}>
              {[
                ...
                {key:"bonusActionUsed",label:"Bonus Action", emoji:"➕", color:"var(--amber)",   bg:"rgba(245,158,11,0.1)",  border:"rgba(245,158,11,0.35)", hints:"Cast a Spell, Offhand Attack, Cunning Action, Wild Shape, Rage, Bardic Inspiration, Healing Word, Misty Step, Shield of Faith"},
                {key:"reactionUsed",   label:"Reaction",     emoji:"⚡", color:"var(--green)",   bg:"rgba(34,197,94,0.1)",   border:"rgba(34,197,94,0.35)",  hints:"Opportunity Attack, Shield, Counterspell, Absorb Elements, Feather Fall, Hellish Rebuke, Readied Action, Uncanny Dodge, Silvery Barbs, Cutting Words"},
 ...
 const [open,setOpen] = [openActionSections[key], (v)=>setOpenActionSections(p=>({...p,[key]:v}))];
 return (
                        <div style={{flex:1,background:"var(--card)",border:"1px solid var(--border)",borderRadius:12,overflow:"hidden",minHeight:72}}>
                          {/* Header row */}
