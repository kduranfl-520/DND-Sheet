...
function App() {
 ...
 onClick={()=>setCharSaving(p=>{const a=[...(p.weaponItems||[])];a.splice(idx,1);return {...p,weaponItems:a};})}>✕</button>
            ...
            {(()=>{
              ...
              const opts_wearing_head = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("helm")||e.title.toLowerCase().includes("hat")||e.title.toLowerCase().includes("head")||e.title.toLowerCase().includes("crown")||e.title.toLowerCase().includes("circlet")||e.title.toLowerCase().includes("hood")||e.title.toLowerCase().includes("eye")||e.title.toLowerCase().includes("goggle"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_arms = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("arm")||e.title.toLowerCase().includes("bracer")||e.title.toLowerCase().includes("sleeve")||e.title.toLowerCase().includes("vambrace"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_hands = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("glove")||e.title.toLowerCase().includes("gauntlet")||e.title.toLowerCase().includes("hand")||e.title.toLowerCase().includes("ring")||e.title.toLowerCase().includes("mitten"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_hips = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("belt")||e.title.toLowerCase().includes("girdle")||e.title.toLowerCase().includes("hip"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_feet = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("boot")||e.title.toLowerCase().includes("slipper")||e.title.toLowerCase().includes("shoe")||e.title.toLowerCase().includes("sandal"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
