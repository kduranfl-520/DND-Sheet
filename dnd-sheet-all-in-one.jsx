...
window.DND_LIBRARY = {
 ...
 LIB_CATS: ["Race","Subrace","Class","Subclass","CL Feature","Background","Armor","Shield","Weapon","Equipment","Spell","Scroll","Potion","Wand & Rod","Magic Item","Jewelry","Gem","Component","Tool","Deity","Faction","Companion","Feat","Other"],
 LIB_SEED: [
 ...
 {id:"sp_tce_sumfey", title:"Summon Fey", category:"Spell",phb:false,tags:"3rd,conjuration,TCE", desc:"You call forth a fey spirit. It manifests in an unoccupied space within range.", notes:"Level: 3rd. School: Conjuration. Cast: Act. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 hour. Upcast: Creature improves at higher s..."},
 ...
 {id:"sp_tce_intlctsm", title:"Intellect Fortress", category:"Spell",phb:false,tags:"3rd,abjuration,TCE", desc:"For the duration, you or one willing creature you can see within range has resist psychic damage.", notes:"Level: 3rd. School: Abjuration. Cast: Act. Range: 30ft Components: V. Duration: Conc, 1 hour. Upcast: +1 creature per slot above 3rd. Clas..."},
 ...
 {id:"sp_tce_magicalmstr", title:"Tasha's Caustic Brew", category:"Spell",phb:false,tags:"1st,evocation,TCE", desc:"A stream of acid emanates from you in a 30-ft line 5 ft wide.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: Self (30 ft line). Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Damage: 2d4 ac..."},
 ...
 {id:"sp_tce_thunderous", title:"Thunderous Smite", category:"Spell",phb:false,tags:"1st,evocation,TCE", desc:"The first time you hit with a melee weapon attack during this spell's duration, your weapon rings with thunder.", notes:"Level: 1st. School: Evocation. Cast: BA. Range: Self. Components: V. Duration: Conc, 1 minute. Damage: +2d6 thunder, push 10 ft, knock pro..."},
 ...
 {id:"sp_tce_vertstrue", title:"Vortex Warp", category:"Spell",phb:false,tags:"2nd,conjuration,TCE", desc:"You magically twist space around another creature, teleporting it.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 90 ft. Components: V,S. Duration: Instantaneous. Save: CON (unwilling targets). Upcast:..."},
 ...
 {id:"sp_tce_borealwind", title:"Boreal Wind", category:"Spell",phb:false,tags:"2nd,evocation,TCE", desc:"Icy wind blasts from you in a 15-ft cone.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: Self (15 ft cone). Components: V,S. Duration: Instantaneous. Save: STR. Damage: 3d8 cold...."},
 {id:"sp_tce_borrowedknow", title:"Borrowed Knowledge", category:"Spell",phb:false,tags:"2nd,divination,TCE", desc:"You momentarily borrow the knowledge of a skill.", notes:"Level: 2nd. School: Divination. Cast: Act. Range: Self. Components: V,S,M. Duration: 1 hour. Effect: Prof in chosen skill for duration. Cl..."},
 {id:"sp_tce_wrdofbloom", title:"Warding Wind", category:"Spell",phb:false,tags:"2nd,evocation,TCE", desc:"A strong wind (20 mph) blows around you in a 10-ft radius.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: Self. Components: V. Duration: Conc, 10 minutes. Effect: Deafened, extinguish small flame..."},
 ...
 {id:"sp_firebolt", title:"Fire Bolt", category:"Spell", phb:true, tags:"cantrip,evocation,ranged,PHB", desc:"You hurl a mote of fire at a creature or object within range.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 120 ft. Components: V, S. Duration: Instantaneous. Attack/Save: Ranged spell attack. ..."},
 {id:"sp_sacredflame", title:"Sacred Flame", category:"Spell", phb:true, tags:"cantrip,evocation,save,PHB", desc:"Flame-like radiance descends on a creature within range.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 60ft Components: V, S. Duration: Instantaneous. Attack/Save: DEX save. Damage: 1d8 ra..."},
 ...
 {id:"sp_minorillusion",title:"Minor Illusion", category:"Spell", phb:true, tags:"cantrip,illusion,utility,PHB", desc:"You create a sound or image of an object within range.", notes:"Level: Cantrip. School: Illusion. Cast: Act. Range: 30ft Components: S, M (a bit of fleece). Duration: 1 minute. Classes: Bard, Sorcerer, ..."},
 {id:"sp_vicmockery", title:"Vicious Mockery", category:"Spell", phb:true, tags:"cantrip,enchantment,save,PHB", desc:"You unleash a string of insults laced with subtle enchantments.", notes:"Level: Cantrip. School: Enchantment. Cast: Act. Range: 60ft Components: V. Duration: Instantaneous. Attack/Save: WIS save. Damage: 1d4 psy..."},
 {id:"sp_curewounds", title:"Cure Wounds", category:"Spell", phb:true, tags:"1st,evocation,healing,PHB", desc:"A creature you touch regains a number of HP = 1d8 + your spellcasting mod.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: Touch. Components: V, S. Duration: Instantaneous. Upcast: +1d8 per slot level above 1st. ..."},
 {id:"sp_magicmissile",title:"Magic Missile", category:"Spell", phb:true, tags:"1st,evocation,force,PHB", desc:"You create three glowing darts of magical force that automatically hit.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: 120 ft. Components: V, S. Duration: Instantaneous. Damage: 3 darts, each 1d4+1 force. Upc..."},
 {id:"sp_shield", title:"Shield", category:"Spell", phb:true, tags:"1st,abjuration,defense,PHB", desc:"An invisible barrier of magical force appears to protect you.", notes:"Level: 1st. School: Abjuration. Cast: Rxn (when hit or targeted by Magic Missile). Range: Self. Components: V, S. Duration: 1 round. Effec..."},
 {id:"sp_healingword", title:"Healing Word", category:"Spell", phb:true, tags:"1st,evocation,healing,PHB", desc:"A creature of your choice regains HP = 1d4 + your spellcasting mod.", notes:"Level: 1st. School: Evocation. Cast: BA. Range: 60ft Components: V. Duration: Instantaneous. Upcast: +1d4 per slot level above 1st. Classe..."},
 {id:"sp_bless", title:"Bless", category:"Spell", phb:true, tags:"1st,enchantment,buff,PHB", desc:"You bless up to three creatures of your choice, adding 1d4 to atk rolls and saves.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 30ft Components: V, S, M (a sprinkling of holy water). Duration: Conc, up to 1 minute. ..."},
 {id:"sp_charmper", title:"Charm Person", category:"Spell", phb:true, tags:"1st,enchantment,save,PHB", desc:"You attempt to charm a humanoid you can see within range.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 30ft Components: V, S. Duration: 1 hour. Attack/Save: WIS save. Upcast: +1 target per s..."},
 {id:"sp_detectmagic", title:"Detect Magic", category:"Spell", phb:true, tags:"1st,divination,ritual,PHB", desc:"For the duration you sense the presence of magic within 30ft of you.", notes:"Level: 1st. School: Divination (Ritual). Cast: Act. Range: Self. Components: V, S. Duration: Conc, up to 10 minutes. Classes: Bard, Cleric..."},
 {id:"sp_sleep", title:"Sleep", category:"Spell", phb:true, tags:"1st,enchantment,save,PHB", desc:"This spell sends creatures into a magical slumber.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 90 ft. Components: V, S, M. Duration: 1 minute. Effect: 5d8 HP worth of creatures fall ..."},
 ...
 {id:"sp_passnotrace", title:"Pass without Trace",category:"Spell",phb:true, tags:"2nd,abjuration,stealth,PHB", desc:"A veil of shadows and silence radiates from you, masking you and your companions.", notes:"Level: 2nd. School: Abjuration. Cast: Act. Range: Self. Components: V, S, M. Duration: Conc, up to 1 hour. Effect: You and creatures withi..."},
 {id:"sp_invisibility",title:"Invisibility", category:"Spell", phb:true, tags:"2nd,illusion,buff,PHB", desc:"A creature you touch becomes invisible until the spell ends.", notes:"Level: 2nd. School: Illusion. Cast: Act. Range: Touch. Components: V, S, M. Duration: Conc, up to 1 hour. Upcast: +1 creature per slot lev..."},
 {id:"sp_fireball", title:"Fireball", category:"Spell", phb:true, tags:"3rd,evocation,fire,PHB", desc:"A bright streak flashes from your finger to a point you choose and then blossoms with a low roar.", notes:"Level: 3rd. School: Evocation. Cast: Act. Range: 150 ft. Components: V, S, M. Duration: Instantaneous. Attack/Save: DEX save. Damage: 8d6 ..."},
 {id:"sp_revivify", title:"Revivify", category:"Spell", phb:true, tags:"3rd,necromancy,healing,PHB", desc:"You touch a creature that has died within the last minute. It returns to life with 1 HP.", notes:"Level: 3rd. School: Necromancy. Cast: Act. Range: Touch. Components: V, S, M (diamonds worth 300 gp). Duration: Instantaneous. Classes: Cl..."},
 {id:"sp_counterspell",title:"Counterspell", category:"Spell", phb:true, tags:"3rd,abjuration,reaction,PHB", desc:"You attempt to interrupt a creature in the process of casting a spell.", notes:"Level: 3rd. School: Abjuration. Cast: Rxn. Range: 60ft Components: S. Duration: Instantaneous. Effect: Automatically stops spells of 3rd l..."},
 {id:"sp_divination", title:"Divination", category:"Spell", phb:true, tags:"4th,divination,ritual,PHB", desc:"Your magic and an offering put you in contact with a god or a god's servants.", notes:"Level: 4th. School: Divination (Ritual). Cast: Act. Range: Self. Components: V, S, M (incense and a sacrificial offering). Duration: Insta..."},
 {id:"sp_greaterrest", title:"Greater Restoration",category:"Spell",phb:true,tags:"5th,abjuration,healing,PHB", desc:"You imbue a creature with positive energy to undo a debilitating effect.", notes:"Level: 5th. School: Abjuration. Cast: Act. Range: Touch. Components: V, S, M (diamond dust worth 100 gp). Duration: Instantaneous. Effect:..."},
 {id:"sp_masshealing", title:"Mass Cure Wounds", category:"Spell", phb:true, tags:"5th,evocation,healing,PHB", desc:"A wave of healing energy washes out from a point you choose, healing up to 6 creatures.", notes:"Level: 5th. School: Evocation. Cast: Act. Range: 60ft Components: V, S. Duration: Instantaneous. Heal: 3d8 + spellcasting mod each. Upcast..."},

 {id:"sp_acidsplash", title:"Acid Splash", category:"Spell",phb:true,tags:"cantrip,conjuration,PHB", desc:"You hurl a bubble of acid. Choose one or two creatures within 5 ft of each other.", notes:"Level: Cantrip. School: Conjuration. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Save: DEX. Damage: 1d6 acid (2d6/5th..."},
 ...
 {id:"sp_chill", title:"Chill Touch", category:"Spell",phb:true,tags:"cantrip,necromancy,PHB", desc:"You create a ghostly skeletal hand that grabs at a creature. Prevents regaining HP until your next turn.", notes:"Level: Cantrip. School: Necromancy. Cast: Act. Range: 120 ft. Components: V,S. Duration: 1 round. Attack: Ranged spell attack. Damage: 1d8..."},
 ...
 {id:"sp_eldblast", title:"Eldritch Blast", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"A beam of crackling energy streaks toward a creature within range. Make a ranged spell attack.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack. Damage..."},
 {id:"sp_friends", title:"Friends", category:"Spell",phb:true,tags:"cantrip,enchantment,PHB", desc:"You gain adv on CHA checks against one nonhostile creature for the duration.", notes:"Level: Cantrip. School: Enchantment. Cast: Act. Range: Self. Components: S,M. Duration: Conc, 1 minute. Classes: Bard, Sorcerer, Warlock, ..."},
 {id:"sp_frostbite", title:"Frostbite", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"You cause numbing frost to form on one creature. On a failed CON save, it has disadv on its next weapon atk roll before the spell ends.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Save: CON. Damage: 1d6 cold (2d6/5th, ..."},
 {id:"sp_infestation", title:"Infestation", category:"Spell",phb:true,tags:"cantrip,conjuration,PHB", desc:"You cause a cloud of mites, fleas, and other parasites to appear momentarily on one creature.", notes:"Level: Cantrip. School: Conjuration. Cast: Act. Range: 30ft Components: V,S,M. Duration: Instantaneous. Save: CON. Damage: 1d6 poison. Cla..."},
 ...
 {id:"sp_mending", title:"Mending", category:"Spell",phb:true,tags:"cantrip,transmutation,PHB", desc:"This spell repairs a single break or tear in an object.", notes:"Level: Cantrip. School: Transmutation. Cast: 1 minute. Range: Touch. Components: V,S,M. Duration: Instantaneous. Classes: Bard, Cleric, Dr..."},
 ...
 {id:"sp_poisonspray", title:"Poison Spray", category:"Spell",phb:true,tags:"cantrip,conjuration,PHB", desc:"You extend your hand toward a creature you can see within range and project a puff of noxious gas.", notes:"Level: Cantrip. School: Conjuration. Cast: Act. Range: 10 ft. Components: V,S. Duration: Instantaneous. Save: CON. Damage: 1d12 poison (2d..."},
 {id:"sp_prestig", title:"Prestidigitation", category:"Spell",phb:true,tags:"cantrip,transmutation,PHB", desc:"This spell is a minor magical trick used by apprentices as practice.", notes:"Level: Cantrip. School: Transmutation. Cast: Act. Range: 10 ft. Components: V,S. Duration: Up to 1 hour. Classes: Bard, Sorcerer, Warlock,..."},
 {id:"sp_producefm", title:"Produce Flame", category:"Spell",phb:true,tags:"cantrip,conjuration,PHB", desc:"A flickering flame appears in your hand. You can hurl it as a ranged spell attack.", notes:"Level: Cantrip. School: Conjuration. Cast: Act. Range: Self/30ft Components: V,S. Duration: 10 minutes. Attack: Ranged spell attack. Damag..."},
 {id:"sp_rayoffrost", title:"Ray of Frost", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"A frigid beam of blue-white light streaks toward a creature within range. -10 ft speed on hit.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack. Damage: 1..."},
 ...
 {id:"sp_shockgrsp", title:"Shocking Grasp", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"Lightning springs from your hand to deliver a shock to a creature. Adv if target wears metal armor.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: Touch. Components: V,S. Duration: Instantaneous. Attack: Melee spell attack. Damage: ..."},
 ...
 {id:"sp_starywisp", title:"Starry Wisp", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"You launch a mote of light at one creature within range. Marks the target, preventing hiding.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack. Damage: 1..."},
 ...
 {id:"sp_thornwhip", title:"Thorn Whip", category:"Spell",phb:true,tags:"cantrip,transmutation,PHB", desc:"You create a long vine-like whip covered in thorns that lashes out at your command.", notes:"Level: Cantrip. School: Transmutation. Cast: Act. Range: 30ft Components: V,S,M. Duration: Instantaneous. Attack: Melee spell attack. Dama..."},
 {id:"sp_thunderclap", title:"Thunderclap", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"You create a burst of thunderous sound that can be heard up to 100 ft away.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: Self (5 ft). Components: S. Duration: Instantaneous. Save: CON. Damage: 1d6 thunder. ..."},
 ...
 {id:"sp_wordsofrad", title:"Word of Radiance", category:"Spell",phb:true,tags:"cantrip,evocation,PHB", desc:"You utter a divine word, and burning radiance erupts from you.", notes:"Level: Cantrip. School: Evocation. Cast: Act. Range: Self (5 ft). Components: V,M. Duration: Instantaneous. Save: CON. Damage: 1d6 radiant..."},
 {id:"sp_absorb", title:"Absorb Elements", category:"Spell",phb:true,tags:"1st,abjuration,PHB", desc:"The spell captures some of the incoming energy, lessening its effect on you and storing it for your next melee attack.", notes:"Level: 1st. School: Abjuration. Cast: Rxn. Range: Self. Components: S. Duration: 1 round. Effect: Resist triggering damage type, add 1d6 t..."},
 ...
 {id:"sp_bane", title:"Bane", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"Up to three creatures of your choice must subtract 1d4 from atk rolls and saves.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 30ft Components: V,S,M. Duration: Conc, 1 minute. Save: CHA. Upcast: +1 creature per sl..."},
 {id:"sp_burninghd", title:"Burning Hands", category:"Spell",phb:true,tags:"1st,evocation,fire,PHB", desc:"A thin sheet of flames shoots forth from your outstretched fingertips.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: Self (15 ft cone). Components: V,S. Duration: Instantaneous. Save: DEX. Damage: 3d6 fire...."},
 ...
 {id:"sp_command1", title:"Command", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"You speak a one-word command to a creature you can see within range.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: 60ft Components: V. Duration: 1 round. Save: WIS. Upcast: +1 creature per slot above 1s..."},
 ...
 {id:"sp_crorndes", title:"Create or Destroy Water",category:"Spell",phb:true,tags:"1st,transmutation,PHB", desc:"You either create or destroy water. Create 10 gallons in an open container or 30-ft cube of fog.", notes:"Level: 1st. School: Transmutation. Cast: Act. Range: 30ft Components: V,S,M. Duration: Instantaneous. Upcast: +10 gallons or +5 ft per slo..."},
 ...
 {id:"sp_falslife", title:"False Life", category:"Spell",phb:true,tags:"1st,necromancy,PHB", desc:"Bolstering yourself with a necromantic facsimile of life, you gain 1d4+4 temporary HP.", notes:"Level: 1st. School: Necromancy. Cast: Act. Range: Self. Components: V,S,M. Duration: 1 hour. Upcast: +5 temp HP per slot above 1st. Classe..."},
 ...
 {id:"sp_fogcloud", title:"Fog Cloud", category:"Spell",phb:true,tags:"1st,conjuration,PHB", desc:"You create a 20-ft radius sphere of fog centered on a point within range.", notes:"Level: 1st. School: Conjuration. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 1 hour. Upcast: Radius +20 ft per slot above 1..."},
 ...
 {id:"sp_guidance1", title:"Guiding Bolt", category:"Spell",phb:true,tags:"1st,evocation,radiant,PHB", desc:"A flash of light streaks toward a creature. The next atk roll against the target has adv.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S. Duration: 1 round. Attack: Ranged spell attack. Damage: 4d6 radi..."},
 {id:"sp_heroism", title:"Heroism", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"A willing creature you touch is imbued with bravery. Immune to frightened, gains temp HP = spellcasting mod each turn.", notes:"Level: 1st. School: Enchantment. Cast: Act. Range: Touch. Components: V,S. Duration: Conc, 1 minute. Upcast: +1 creature per slot above 1s..."},
 ...
 {id:"sp_identify", title:"Identify", category:"Spell",phb:true,tags:"1st,divination,ritual,PHB", desc:"You choose one object you must touch throughout the casting of the spell to learn its properties.", notes:"Level: 1st. School: Divination (Ritual). Cast: 1 minute. Range: Touch. Components: V,S,M (pearl worth 100 gp). Duration: Instantaneous. Cl..."},
 {id:"sp_illfavorite", title:"Inflict Wounds", category:"Spell",phb:true,tags:"1st,necromancy,PHB", desc:"Make a melee spell attack against a creature you can reach. On a hit, deal 3d10 necrotic damage.", notes:"Level: 1st. School: Necromancy. Cast: Act. Range: Touch. Components: V,S. Duration: Instantaneous. Attack: Melee spell attack. Damage: 3d1..."},
 ...
 {id:"sp_longstrider", title:"Longstrider", category:"Spell",phb:true,tags:"1st,transmutation,PHB", desc:"You touch a creature. Its speed increases by 10 ft until the spell ends.", notes:"Level: 1st. School: Transmutation. Cast: Act. Range: Touch. Components: V,S,M. Duration: 1 hour. Upcast: +1 creature per slot above 1st. C..."},
 ...
 {id:"sp_prtevil", title:"Protection from Evil and Good",category:"Spell",phb:true,tags:"1st,abjuration,PHB", desc:"Until the spell ends, one willing creature you touch is protected against aberrations, celestials, elementals, fey, fiends, and undead.", notes:"Level: 1st. School: Abjuration. Cast: Act. Range: Touch. Components: V,S,M. Duration: Conc, 10 minutes. Classes: Cleric, Paladin, Warlock,..."},
 {id:"sp_rayenf", title:"Ray of Sickness", category:"Spell",phb:true,tags:"1st,necromancy,PHB", desc:"A ray of sickening greenish energy lashes out toward a creature within range.", notes:"Level: 1st. School: Necromancy. Cast: Act. Range: 60ft Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack. Damage: 2d8 ..."},
 ...
 {id:"sp_searsmite", title:"Searing Smite", category:"Spell",phb:true,tags:"1st,evocation,PHB", desc:"The next time you hit a creature with a melee weapon attack, it burns with white-hot intensity.", notes:"Level: 1st. School: Evocation. Cast: BA. Range: Self. Components: V. Duration: Conc, 1 minute. Damage: 1d6 fire on hit, then 1d6 each turn..."},
 ...
 {id:"sp_witchbolt", title:"Witch Bolt", category:"Spell",phb:true,tags:"1st,evocation,PHB", desc:"A beam of crackling lightning forms between you and a target. You can use your act to deal damage each turn.", notes:"Level: 1st. School: Evocation. Cast: Act. Range: 30ft Components: V,S,M. Duration: Conc, 1 minute. Attack: Ranged spell attack. Damage: 1d..."},
 {id:"sp_wrthfulsmite", title:"Wrathful Smite", category:"Spell",phb:true,tags:"1st,evocation,PHB", desc:"The next time you hit with a melee weapon attack during the spell's duration, your strike channels divine wrath.", notes:"Level: 1st. School: Evocation. Cast: BA. Range: Self. Components: V. Duration: Conc, 1 minute. Damage: +1d6 psychic, target frightened on ..."},
 {id:"sp_aid", title:"Aid", category:"Spell",phb:true,tags:"2nd,abjuration,PHB", desc:"Your spell bolsters your allies with toughness and resolve. Each creature gains 5 max HP.", notes:"Level: 2nd. School: Abjuration. Cast: Act. Range: 30ft Components: V,S,M. Duration: 8 hours. Upcast: +5 HP per slot above 2nd. Classes: Ba..."},
 ...
 {id:"sp_anmsg", title:"Animal Messenger", category:"Spell",phb:true,tags:"2nd,enchantment,ritual,PHB", desc:"By means of this spell, you use an animal to deliver a message.", notes:"Level: 2nd. School: Enchantment (Ritual). Cast: Act. Range: 30ft Components: V,S,M. Duration: 24 hours. Upcast: Duration x2 per slot above..."},
 ...
 {id:"sp_blinddeaf", title:"Blindness/Deafness", category:"Spell",phb:true,tags:"2nd,necromancy,PHB", desc:"You can blind or deafen a foe. Choose one creature within range. Save or be blinded or deafened.", notes:"Level: 2nd. School: Necromancy. Cast: Act. Range: 30ft Components: V. Duration: 1 minute. Save: CON. Upcast: +1 creature per slot above 2n..."},
 ...
 {id:"sp_clouddag", title:"Cloud of Daggers", category:"Spell",phb:true,tags:"2nd,conjuration,PHB", desc:"You fill the air in a 5-ft cube with spinning daggers.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 minute. Damage: 4d4 slashing /turn. Upcast: +..."},
 ...
 {id:"sp_detthts", title:"Detect Thoughts", category:"Spell",phb:true,tags:"2nd,divination,PHB", desc:"For the duration, you can read the thoughts of certain creatures.", notes:"Level: 2nd. School: Divination. Cast: Act. Range: Self. Components: V,S,M. Duration: Conc, 1 minute. Save: WIS. Classes: Bard, Sorcerer, W..."},
 ...
 {id:"sp_enhanceab", title:"Enhance Ability", category:"Spell",phb:true,tags:"2nd,transmutation,PHB", desc:"You touch a creature and bestow upon it a magical enhancement.", notes:"Level: 2nd. School: Transmutation. Cast: Act. Range: Touch. Components: V,S,M. Duration: Conc, 1 hour. Upcast: +1 creature per slot above ..."},
 ...
 {id:"sp_flameblade", title:"Flame Blade", category:"Spell",phb:true,tags:"2nd,evocation,PHB", desc:"You evoke a fiery blade in your free hand. You can use it as a melee spell attack for 3d6 fire.", notes:"Level: 2nd. School: Evocation. Cast: BA. Range: Self. Components: V,S,M. Duration: Conc, 10 minutes. Upcast: +1d6 at 4th level, again at 6..."},
 {id:"sp_flmsphr", title:"Flaming Sphere", category:"Spell",phb:true,tags:"2nd,conjuration,PHB", desc:"A 5-ft-diameter sphere of fire appears in an unoccupied space. It deals 2d6 fire damage.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Upcast: +1d6 per slot abov..."},
 {id:"sp_gust", title:"Gust of Wind", category:"Spell",phb:true,tags:"2nd,evocation,PHB", desc:"A line of strong wind 60 ft long and 10 ft wide blasts from you in a direction you choose.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: Self (60 ft line). Components: V,S,M. Duration: Conc, 1 minute. Save: STR. Classes: Druid..."},
 {id:"sp_heatmetal", title:"Heat Metal", category:"Spell",phb:true,tags:"2nd,transmutation,PHB", desc:"Choose a manufactured metal object within range. The creature holding it takes 2d8 fire damage.", notes:"Level: 2nd. School: Transmutation. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 minute. Upcast: +1d8 per slot above 2nd. Cl..."},
 ...
 {id:"sp_levitate", title:"Levitate", category:"Spell",phb:true,tags:"2nd,transmutation,PHB", desc:"One creature or loose object of your choice that you can see within range rises vertically.", notes:"Level: 2nd. School: Transmutation. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 10 minutes. Save: CON. Classes: Sorcerer, Wiz..."},
 {id:"sp_magicwpn", title:"Magic Weapon", category:"Spell",phb:true,tags:"2nd,transmutation,PHB", desc:"You touch a nonmagical weapon. Until the spell ends, that weapon becomes a magic weapon with +1 to attack and damage.", notes:"Level: 2nd. School: Transmutation. Cast: BA. Range: Touch. Components: V,S. Duration: Conc, 1 hour. Upcast: +2 at 4th, +3 at 6th. Classes:..."},
 ...
 {id:"sp_moonbeam", title:"Moonbeam", category:"Spell",phb:true,tags:"2nd,evocation,PHB", desc:"A silvery beam of pale light shines down in a 5-ft radius cylinder.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: CON. Damage: 2d10 radiant. Upc..."},
 {id:"sp_prayerheal", title:"Prayer of Healing", category:"Spell",phb:true,tags:"2nd,evocation,PHB", desc:"Up to six creatures each regain HP = 2d8 + spellcasting mod.", notes:"Level: 2nd. School: Evocation. Cast: 10 minutes. Range: 30ft Components: V. Duration: Instantaneous. Upcast: +1d8 per slot above 2nd. Clas..."},
 {id:"sp_scorchray", title:"Scorching Ray", category:"Spell",phb:true,tags:"2nd,evocation,fire,PHB", desc:"You create three rays of fire and hurl them at targets within range.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S. Duration: Instantaneous. Attack: Ranged spell attack per ray. Da..."},
 ...
 {id:"sp_shatter", title:"Shatter", category:"Spell",phb:true,tags:"2nd,evocation,PHB", desc:"A sudden loud ringing noise emanates from a point of your choice within range.", notes:"Level: 2nd. School: Evocation. Cast: Act. Range: 60ft Components: V,S,M. Duration: Instantaneous. Save: CON. Damage: 3d8 thunder. Upcast: ..."},
 ...
 {id:"sp_sumbeast", title:"Summon Beast", category:"Spell",phb:true,tags:"2nd,conjuration,PHB", desc:"You call forth a bestial spirit. It manifests in an unoccupied space that you can see within range.", notes:"Level: 2nd. School: Conjuration. Cast: Act. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 hour. Upcast: Creature improves at higher l..."},
 {id:"sp_wardingbond", title:"Warding Bond", category:"Spell",phb:true,tags:"2nd,abjuration,PHB", desc:"This spell wards a willing creature you touch and creates a mystic connection between you.", notes:"Level: 2nd. School: Abjuration. Cast: Act. Range: Touch. Components: V,S,M (250 gp). Duration: 1 hour. Effect: +1 AC, +1 saves, resist all..."},
 ...
 {id:"sp_animdead", title:"Animate Dead", category:"Spell",phb:true,tags:"3rd,necromancy,PHB", desc:"This spell creates an undead servant. Choose a pile of bones or corpse within range.", notes:"Level: 3rd. School: Necromancy. Cast: 1 minute. Range: 10 ft. Components: V,S,M. Duration: Instantaneous. Effect: Creates skeleton or zomb..."},
 ...
 {id:"sp_bestcurse", title:"Bestow Curse", category:"Spell",phb:true,tags:"3rd,necromancy,PHB", desc:"You touch a creature, and that creature must succeed on a WIS save or become cursed.", notes:"Level: 3rd. School: Necromancy. Cast: Act. Range: Touch. Components: V,S. Duration: Conc, 1 minute (Upcast: longer). Save: WIS. Classes: B..."},
 ...
 {id:"sp_calllight", title:"Call Lightning", category:"Spell",phb:true,tags:"3rd,conjuration,PHB", desc:"A storm cloud appears. Each turn, you can call down lightning to deal 3d10 lightning damage.", notes:"Level: 3rd. School: Conjuration. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 10 minutes. Save: DEX. Upcast: +1d10 per slot ..."},
 {id:"sp_clairiov", title:"Clairvoyance", category:"Spell",phb:true,tags:"3rd,divination,PHB", desc:"You create an invisible sensor within range in a location familiar to you or in a location.", notes:"Level: 3rd. School: Divination. Cast: 10 minutes. Range: 1 mile. Components: V,S,M (100 gp). Duration: Conc, 10 minutes. Classes: Bard, Cl..."},
 {id:"sp_conjanimals", title:"Conjure Animals", category:"Spell",phb:true,tags:"3rd,conjuration,PHB", desc:"You summon fey spirits that take the form of beasts.", notes:"Level: 3rd. School: Conjuration. Cast: Act. Range: 60ft Components: V,S. Duration: Conc, 1 hour. Upcast: More/stronger beasts per slot abo..."},
 ...
 {id:"sp_fly3", title:"Fly", category:"Spell",phb:true,tags:"3rd,transmutation,PHB", desc:"You touch a willing creature. The target gains a flying speed of 60 ft for the duration.", notes:"Level: 3rd. School: Transmutation. Cast: Act. Range: Touch. Components: V,S,M. Duration: Conc, 10 minutes. Upcast: +1 creature per slot ab..."},
 ...
 {id:"sp_lgtbolt", title:"Lightning Bolt", category:"Spell",phb:true,tags:"3rd,evocation,lightning,PHB",desc:"A stroke of lightning forming a line 100 ft long and 5 ft wide blasts out from you.", notes:"Level: 3rd. School: Evocation. Cast: Act. Range: Self (100 ft line). Components: V,S,M. Duration: Instantaneous. Save: DEX. Damage: 8d6 li..."},
 {id:"sp_majimage", title:"Major Image", category:"Spell",phb:true,tags:"3rd,illusion,PHB", desc:"You create the image of an object, creature, or other visible phenomenon that is no larger than a 20-ft cube.", notes:"Level: 3rd. School: Illusion. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 10 minutes (Permanent at 6th). Classes: Bard, S..."},
 {id:"sp_masshealwrd", title:"Mass Healing Word", category:"Spell",phb:true,tags:"3rd,evocation,PHB", desc:"As you call out words of restoration, up to six creatures of your choice regain 1d4 + spellcasting mod HP.", notes:"Level: 3rd. School: Evocation. Cast: BA. Range: 60ft Components: V. Duration: Instantaneous. Upcast: +1d4 per slot above 3rd. Classes: Bar..."},
 {id:"sp_plantgrow", title:"Plant Growth", category:"Spell",phb:true,tags:"3rd,transmutation,PHB", desc:"This spell channels vitality into plants within a region or creates difficult terrain.", notes:"Level: 3rd. School: Transmutation. Cast: Act or 8 hours. Range: 150 ft. Components: V,S. Duration: Instantaneous. Classes: Bard, Druid, Ra..."},
 {id:"sp_prtfenrgy", title:"Protection from Energy",category:"Spell",phb:true,tags:"3rd,abjuration,PHB", desc:"For the duration, the willing creature you touch has resist one damage type of your choice.", notes:"Level: 3rd. School: Abjuration. Cast: Act. Range: Touch. Components: V,S. Duration: Conc, 1 hour. Classes: Cleric, Druid, Ranger, Sorcerer..."},
 {id:"sp_remcurse", title:"Remove Curse", category:"Spell",phb:true,tags:"3rd,abjuration,PHB", desc:"At your touch, all curses affecting one creature or object end.", notes:"Level: 3rd. School: Abjuration. Cast: Act. Range: Touch. Components: V,S. Duration: Instantaneous. Classes: Cleric, Paladin, Warlock, Wiza..."},
 ...
 {id:"sp_sleetstrm", title:"Sleet Storm", category:"Spell",phb:true,tags:"3rd,conjuration,PHB", desc:"Until the spell ends, freezing rain and sleet fall in a 20-ft tall cylinder with a 40-ft radius.", notes:"Level: 3rd. School: Conjuration. Cast: Act. Range: 150 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Classes: Druid, Sorcere..."},
 {id:"sp_slow", title:"Slow", category:"Spell",phb:true,tags:"3rd,transmutation,PHB", desc:"You alter time around up to six creatures of your choice in a 40-ft cube within range.", notes:"Level: 3rd. School: Transmutation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: WIS. Classes: Sorcerer, Wi..."},
 ...
 {id:"sp_tongues", title:"Tongues", category:"Spell",phb:true,tags:"3rd,divination,PHB", desc:"This spell grants the creature you touch the ability to understand any spoken language.", notes:"Level: 3rd. School: Divination. Cast: Act. Range: Touch. Components: V,M. Duration: 1 hour. Classes: Bard, Cleric, Sorcerer, Warlock, Wiza..."},
 {id:"sp_vamptouch", title:"Vampiric Touch", category:"Spell",phb:true,tags:"3rd,necromancy,PHB", desc:"The touch of your shadow-wreathed hand can siphon life force from others. Deals 3d6 necrotic, heals half.", notes:"Level: 3rd. School: Necromancy. Cast: Act. Range: Self. Components: V,S. Duration: Conc, 1 minute. Attack: Melee spell attack. Damage: 3d6..."},
 {id:"sp_watbreath", title:"Water Breathing", category:"Spell",phb:true,tags:"3rd,transmutation,ritual,PHB",desc:"This spell grants up to ten willing creatures the ability to breathe underwater.", notes:"Level: 3rd. School: Transmutation (Ritual). Cast: Act. Range: 30ft Components: V,S,M. Duration: 24 hours. Classes: Druid, Ranger, Sorcerer..."},
 {id:"sp_windwall", title:"Wind Wall", category:"Spell",phb:true,tags:"3rd,evocation,PHB", desc:"A wall of strong wind rises from the ground at a point you choose within range.", notes:"Level: 3rd. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: STR. Damage: 3d8 bludgeoning. ..."},
 ...
 {id:"sp_banishment", title:"Banishment", category:"Spell",phb:true,tags:"4th,abjuration,PHB", desc:"You attempt to send one creature you can see within range to another plane of existence.", notes:"Level: 4th. School: Abjuration. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 minute. Save: CHA. Upcast: +1 creature per slo..."},
 {id:"sp_blight", title:"Blight", category:"Spell",phb:true,tags:"4th,necromancy,PHB", desc:"Necromantic energy washes over a creature, sapping its vitality.", notes:"Level: 4th. School: Necromancy. Cast: Act. Range: 30ft Components: V,S. Duration: Instantaneous. Save: CON. Damage: 8d8 necrotic. Upcast: ..."},
 ...
 {id:"sp_divination4", title:"Divination", category:"Spell",phb:true,tags:"4th,divination,ritual,PHB", desc:"Your magic and an offering put you in contact with a god or a god's servants.", notes:"Level: 4th. School: Divination (Ritual). Cast: Act. Range: Self. Components: V,S,M (incense, 25 gp). Duration: Instantaneous. Classes: Cle..."},
 {id:"sp_domaintest", title:"Dominate Beast", category:"Spell",phb:true,tags:"4th,enchantment,PHB", desc:"You attempt to beguile a beast within range. It must succeed on a WIS save or be charmed.", notes:"Level: 4th. School: Enchantment. Cast: Act. Range: 60ft Components: V,S. Duration: Conc, 1 minute. Save: WIS. Classes: Druid, Ranger, Sorc..."},
 {id:"sp_evardblt", title:"Evard's Black Tentacles",category:"Spell",phb:true,tags:"4th,conjuration,PHB", desc:"Squirming black tentacles fill a 20-ft square on ground you can see within range.", notes:"Level: 4th. School: Conjuration. Cast: Act. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Damage: 3d6 bludgeoning ..."},
 ...
 {id:"sp_grdnfaith", title:"Guardian of Faith", category:"Spell",phb:true,tags:"4th,conjuration,PHB", desc:"A Large spectral guardian appears in an unoccupied space of your choice within range.", notes:"Level: 4th. School: Conjuration. Cast: Act. Range: 30ft Components: V. Duration: 8 hours. Damage: 20 radiant to creatures that move within..."},
 ...
 {id:"sp_icestorm", title:"Ice Storm", category:"Spell",phb:true,tags:"4th,evocation,cold,PHB", desc:"A hail of rock-hard ice pounds to the ground in a 20-ft radius 40-ft high cylinder.", notes:"Level: 4th. School: Evocation. Cast: Act. Range: 300 ft. Components: V,S,M. Duration: Instantaneous. Save: DEX. Damage: 2d8 bludgeoning + ..."},
 ...
 {id:"sp_polymorph", title:"Polymorph", category:"Spell",phb:true,tags:"4th,transmutation,PHB", desc:"This spell transforms a creature that you can see within range into a new form.", notes:"Level: 4th. School: Transmutation. Cast: Act. Range: 60ft Components: V,S,M. Duration: Conc, 1 hour. Save: WIS. Classes: Bard, Cleric, Dru..."},
 ...
 {id:"sp_stoneskin", title:"Stoneskin", category:"Spell",phb:true,tags:"4th,abjuration,PHB", desc:"This spell turns the flesh of a willing creature as hard as stone. Resist nonmagical bludgeoning, piercing, and slashing.", notes:"Level: 4th. School: Abjuration. Cast: Act. Range: Touch. Components: V,S,M (diamond dust 100 gp). Duration: Conc, 1 hour. Classes: Druid, ..."},
 {id:"sp_wallfire", title:"Wall of Fire", category:"Spell",phb:true,tags:"4th,evocation,fire,PHB", desc:"You create a wall of fire on a solid surface within range. The wall is opaque and lasts for the duration.", notes:"Level: 4th. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Save: DEX. Damage: 5d8 fire. Upcast:..."},
 {id:"sp_animobj", title:"Animate Objects", category:"Spell",phb:true,tags:"5th,transmutation,PHB", desc:"Objects come to life at your command. Choose up to ten nonmagical objects within range.", notes:"Level: 5th. School: Transmutation. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 1 minute. Upcast: +2 objects per slot above ..."},
 ...
 {id:"sp_awaken5", title:"Awaken", category:"Spell",phb:true,tags:"5th,transmutation,PHB", desc:"After spending the casting time tracing magical pathways within a precious gem, you touch a Huge or smaller beast or plant.", notes:"Level: 5th. School: Transmutation. Cast: 8 hours. Range: Touch. Components: V,S,M (1000 gp gem). Duration: Instantaneous. Classes: Bard, D..."},
 {id:"sp_bigbyhand", title:"Bigby's Hand", category:"Spell",phb:true,tags:"5th,evocation,PHB", desc:"You create a Large hand of shimmering force that can serve as a shield or attack.", notes:"Level: 5th. School: Evocation. Cast: Act. Range: 120 ft. Components: V,S,M. Duration: Conc, 1 minute. Upcast: +2d8 per slot above 5th. Cla..."},
 {id:"sp_cloudkill", title:"Cloudkill", category:"Spell",phb:true,tags:"5th,conjuration,PHB", desc:"You create a 20-ft radius sphere of poisonous, yellow-green fog.", notes:"Level: 5th. School: Conjuration. Cast: Act. Range: 120 ft. Components: V,S. Duration: Conc, 10 minutes. Save: CON. Damage: 5d8 poison /tur..."},
 {id:"sp_conenecold", title:"Cone of Cold", category:"Spell",phb:true,tags:"5th,evocation,cold,PHB", desc:"A blast of cold air erupts from your hands in a 60-ft cone.", notes:"Level: 5th. School: Evocation. Cast: Act. Range: Self (60 ft cone). Components: V,S,M. Duration: Instantaneous. Save: CON. Damage: 8d8 col..."},
 ...
 {id:"sp_contelm", title:"Conjure Elemental", category:"Spell",phb:true,tags:"5th,conjuration,PHB", desc:"You call forth an elemental servant to serve you.", notes:"Level: 5th. School: Conjuration. Cast: 1 minute. Range: 90 ft. Components: V,S,M. Duration: Conc, 1 hour. Upcast: Higher CR per slot above..."},
 {id:"sp_cncplne", title:"Contact Other Plane", category:"Spell",phb:true,tags:"5th,divination,ritual,PHB", desc:"You mentally contact a demigod, the spirit of a long-dead sage, or some other mysterious entity from another plane.", notes:"Level: 5th. School: Divination (Ritual). Cast: 1 minute. Range: Self. Components: V. Duration: 1 minute. Save: INT or 6d6 psychic. Classes..."},
 {id:"sp_contagion", title:"Contagion", category:"Spell",phb:true,tags:"5th,necromancy,PHB", desc:"Your touch inflicts disease. Make a melee spell attack against a creature.", notes:"Level: 5th. School: Necromancy. Cast: Act. Range: Touch. Components: V,S. Duration: 7 days. Attack: Melee spell attack. Classes: Cleric, D..."},
 {id:"sp_creation5", title:"Creation", category:"Spell",phb:true,tags:"5th,illusion,PHB", desc:"You pull wisps of shadow material from the Shadowfell to create a nonliving object of vegetable matter.", notes:"Level: 5th. School: Illusion. Cast: 1 minute. Range: 30ft Components: V,S,M. Duration: Special. Upcast: More materials per slot above 5th...."},
 ...
 {id:"sp_dominate", title:"Dominate Person", category:"Spell",phb:true,tags:"5th,enchantment,PHB", desc:"You attempt to beguile a humanoid that you can see within range.", notes:"Level: 5th. School: Enchantment. Cast: Act. Range: 60ft Components: V,S. Duration: Conc, 1 minute. Save: WIS. Upcast: Duration extends per..."},
 ...
 {id:"sp_flmstrike", title:"Flame Strike", category:"Spell",phb:true,tags:"5th,evocation,fire,PHB", desc:"A vertical column of divine fire roars down from the heavens in a 10-ft radius 40-ft high cylinder.", notes:"Level: 5th. School: Evocation. Cast: Act. Range: 60ft Components: V,S,M. Duration: Instantaneous. Save: DEX. Damage: 4d6 fire + 4d6 radian..."},
 {id:"sp_geas", title:"Geas", category:"Spell",phb:true,tags:"5th,enchantment,PHB", desc:"You place a magical command on a creature that you can see within range, forcing it to carry out some service or refrain from some act.", notes:"Level: 5th. School: Enchantment. Cast: 1 minute. Range: 60ft Components: V. Duration: 30 days. Save: WIS. Classes: Bard, Cleric, Druid, Pa..."},
 ...
 {id:"sp_inscplague", title:"Insect Plague", category:"Spell",phb:true,tags:"5th,conjuration,PHB", desc:"Swarming locusts fill a 20-ft radius sphere centered on a point you choose within range.", notes:"Level: 5th. School: Conjuration. Cast: Act. Range: 300 ft. Components: V,S,M. Duration: Conc, 10 minutes. Save: CON. Damage: 4d10 piercing..."},
 {id:"sp_legendlore", title:"Legend Lore", category:"Spell",phb:true,tags:"5th,divination,PHB", desc:"Name or describe a person, place, or object. The spell brings to your mind a brief summary of the knowledge.", notes:"Level: 5th. School: Divination. Cast: 10 minutes. Range: Self. Components: V,S,M (250 gp). Duration: Instantaneous. Classes: Bard, Cleric,..."},
 ...
 {id:"sp_plntgrow5", title:"Raise Dead", category:"Spell",phb:true,tags:"5th,necromancy,PHB", desc:"You return a dead creature you touch to life, provided that it has been dead no longer than 10 days.", notes:"Level: 5th. School: Necromancy. Cast: 1 hour. Range: Touch. Components: V,S,M (500 gp diamond). Duration: Instantaneous. Classes: Bard, Cl..."},
 ...
 {id:"sp_scrying5", title:"Scrying", category:"Spell",phb:true,tags:"5th,divination,PHB", desc:"You can see and hear a particular creature you choose that is on the same plane of existence as you.", notes:"Level: 5th. School: Divination. Cast: 10 minutes. Range: Self. Components: V,S,M (focus worth 1000 gp). Duration: Conc, 10 minutes. Save: ..."},
 ...
 {id:"eq_healers_kit",title:"Healer's Kit",category:"Equipment",phb:true,tags:"gear,medical,PHB",desc:"This kit is a leather pouch containing bandages, salves, and splints. Use an action to stabilize a creature with 0 HP, without a Medicine check.",notes:"Cost: 5 gp. Weight: 3 lbs. Uses: 10. Stabilizes creature at 0 HP as an action (no Medicine check required)."},
...
const LIB_CATS = window.DND_LIBRARY?.LIB_CATS || ["Race","Subrace","Class","Subclass","CL Feature","Background","Armor","Shield","Weapon","Equipment","Spell","Scroll","Potion","Wand & Rod","Magic Item","Jewelry","Gem","Component","Tool","Deity","Faction","Companion","Feat","Other"];
