...
window.DND_LIBRARY = {
 ...
 {id:"sr_hilldwarf", title:"Hill Dwarf", category:"Subrace", phb:true, tags:"dwarf,wisdom", desc:"As a hill dwarf, you have keen senses, deep intuition, and remarkable resilience.", notes:"ASI: +1 WIS | Dwarven Toughness: HP maximum increases by 1, and increases by 1 again every time you gain a level | PHB p.20"},
 {id:"sr_mountaindwarf",title:"Mountain Dwarf", category:"Subrace", phb:true, tags:"dwarf,armor", desc:"As a mountain dwarf, you're strong and hardy, acclimated to a difficult life in rugged terrain.", notes:"ASI: +2 STR | Dwarven Armor Training: Proficiency with light and medium armor | PHB p.20"},
 {id:"sr_highelf", title:"High Elf", category:"Subrace", phb:true, tags:"elf,magic", desc:"As a high elf, you have a keen mind and a mastery over at least the basics of magic.", notes:"ASI: +1 INT | Elf Weapon Training: Proficiency with longsword, shortsword, shortbow, and longbow | Cantrip: Learn one wizard cantrip of your choice (INT is spellcasting ability) | Extra Language: One additional language of your choice | PHB p.23"},
 {id:"sr_woodelf", title:"Wood Elf", category:"Subrace", phb:true, tags:"elf,nature", desc:"As a wood elf, you have keen senses and intuition, and your fleet feet carry you quickly through your native forests.", notes:"ASI: +1 WIS | Elf Weapon Training: Proficiency with longsword, shortsword, shortbow, and longbow | Fleet of Foot: Speed increases to 35ft | Mask of the Wild: Can attempt to hide when only lightly obscured by natural phenomena | PHB p.24"},
 {id:"sr_drow", title:"Dark Elf (Drow)", category:"Subrace", phb:true, tags:"elf,underdark", desc:"Descended from an earlier subrace of dark-skinned elves, the drow were banished from the surface world for following the goddess Lolth.", notes:"ASI: +1 CHA | Superior Darkvision: 120ft | Sunlight Sensitivity: Disadvantage on attack rolls and Perception checks in direct sunlight | Drow Magic: Dancing Lights cantrip. Faerie Fire 1/LR at 3rd level. Darkness 1/LR at 5th level. CHA is spellcasting ability | Drow Weapon Training: Proficiency with rapiers, shortswords, and hand crossbows | PHB p.24"},
 {id:"sr_lightfoot", title:"Lightfoot Halfling", category:"Subrace", phb:true, tags:"halfling,stealth", desc:"As a lightfoot halfling, you can easily hide from notice, even using other people as cover.", notes:"ASI: +1 CHA | Naturally Stealthy: Can attempt to hide even when only obscured by a creature at least one size larger | PHB p.28"},
 {id:"sr_stout", title:"Stout Halfling", category:"Subrace", phb:true, tags:"halfling,tough", desc:"As a stout halfling, you're hardier than average and have some resistance to poison.", notes:"ASI: +1 CON | Stout Resilience: Advantage on saving throws against poison, and resistance to poison damage | PHB p.28"},
 {id:"sr_forestgnome", title:"Forest Gnome", category:"Subrace", phb:true, tags:"gnome,illusion", desc:"As a forest gnome, you have a natural knack for illusion and inherent quickness and stealth.", notes:"ASI: +1 DEX | Natural Illusionist: Know Minor Illusion cantrip (INT is spellcasting ability) | Speak with Small Beasts: Communicate simple ideas with Small or smaller beasts through sounds and gestures | PHB p.37"},
 {id:"sr_rockgnome", title:"Rock Gnome", category:"Subrace", phb:true, tags:"gnome,tinker", desc:"As a rock gnome, you have a natural inventiveness and hardiness beyond that of other gnomes.", notes:"ASI: +1 CON | Artificer's Lore: Double proficiency bonus on History checks related to magic items, alchemical objects, or technological devices | Tinker: Proficiency with tinker's tools. Construct Tiny clockwork devices (10gp, 1 hour) | PHB p.37"},
 {id:"sr_db_black", title:"Dragonborn - Black", category:"Subrace", phb:true, tags:"dragonborn,acid", desc:"Black dragonborn carry the legacy of the Black Dragon — acid, cunning, and cruelty.", notes:"Dragon Type: Black | Damage Type: Acid | Breath Weapon: 5x30ft line, DEX save DC 8+prof+CON, 2d6 acid (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Acid | PHB p.34"},
 {id:"sr_db_blue", title:"Dragonborn - Blue", category:"Subrace", phb:true, tags:"dragonborn,lightning", desc:"Blue dragonborn carry the legacy of the Blue Dragon — lightning and desert storms.", notes:"Dragon Type: Blue | Damage Type: Lightning | Breath Weapon: 5x30ft line, DEX save DC 8+prof+CON, 2d6 lightning (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Lightning | PHB p.34"},
 {id:"sr_db_brass", title:"Dragonborn - Brass", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Brass dragonborn carry the legacy of the Brass Dragon — fire and conversation.", notes:"Dragon Type: Brass | Damage Type: Fire | Breath Weapon: 5x30ft line, DEX save DC 8+prof+CON, 2d6 fire (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Fire | PHB p.34"},
 {id:"sr_db_bronze", title:"Dragonborn - Bronze", category:"Subrace", phb:true, tags:"dragonborn,lightning", desc:"Bronze dragonborn carry the legacy of the Bronze Dragon — lightning and the sea.", notes:"Dragon Type: Bronze | Damage Type: Lightning | Breath Weapon: 5x30ft line, DEX save DC 8+prof+CON, 2d6 lightning (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Lightning | PHB p.34"},
 {id:"sr_db_copper", title:"Dragonborn - Copper", category:"Subrace", phb:true, tags:"dragonborn,acid", desc:"Copper dragonborn carry the legacy of the Copper Dragon — acid and mischief.", notes:"Dragon Type: Copper | Damage Type: Acid | Breath Weapon: 5x30ft line, DEX save DC 8+prof+CON, 2d6 acid (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Acid | PHB p.34"},
 {id:"sr_db_gold", title:"Dragonborn - Gold", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Gold dragonborn carry the legacy of the Gold Dragon — fire and nobility.", notes:"Dragon Type: Gold | Damage Type: Fire | Breath Weapon: 15ft cone, DEX save DC 8+prof+CON, 2d6 fire (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Fire | PHB p.34"},
 {id:"sr_db_green", title:"Dragonborn - Green", category:"Subrace", phb:true, tags:"dragonborn,poison", desc:"Green dragonborn carry the legacy of the Green Dragon — poison and deception.", notes:"Dragon Type: Green | Damage Type: Poison | Breath Weapon: 15ft cone, CON save DC 8+prof+CON, 2d6 poison (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Poison | PHB p.34"},
 {id:"sr_db_red", title:"Dragonborn - Red", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Red dragonborn carry the legacy of the Red Dragon — fire and dominance.", notes:"Dragon Type: Red | Damage Type: Fire | Breath Weapon: 15ft cone, DEX save DC 8+prof+CON, 2d6 fire (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Fire | PHB p.34"},
 {id:"sr_db_silver", title:"Dragonborn - Silver", category:"Subrace", phb:true, tags:"dragonborn,cold", desc:"Silver dragonborn carry the legacy of the Silver Dragon — cold and heroism.", notes:"Dragon Type: Silver | Damage Type: Cold | Breath Weapon: 15ft cone, CON save DC 8+prof+CON, 2d6 cold (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Cold | PHB p.34"},
 {id:"sr_db_white", title:"Dragonborn - White", category:"Subrace", phb:true, tags:"dragonborn,cold", desc:"White dragonborn carry the legacy of the White Dragon — cold and savagery.", notes:"Dragon Type: White | Damage Type: Cold | Breath Weapon: 15ft cone, CON save DC 8+prof+CON, 2d6 cold (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Cold | PHB p.34"},
 {id:"sr_tief_asmo", title:"Asmodeus Tiefling", category:"Subrace", phb:true, tags:"tiefling,infernal,fire", desc:"The tieflings connected to Nessus, the deepest layer of the Nine Hells, command the power of fire and darkness guided by Asmodeus.", notes:"ASI: +1 INT, +2 CHA | Infernal Legacy: Thaumaturgy cantrip. Hellish Rebuke 1/LR at 3rd level. Darkness 1/LR at 5th level. CHA is spellcasting ability | PHB p.43 / MToF p.21"},
 {id:"sr_tief_meph", title:"Mephistopheles Tiefling",category:"Subrace",phb:true,tags:"tiefling,cold,arcane", desc:"Tieflings with a blood tie to Mephistopheles are gifted with a particular flair for arcane magic.", notes:"ASI: +1 INT, +2 CHA | Legacy of Cania: Mage Hand cantrip. Burning Hands 1/LR at 3rd level. Flame Blade 1/LR at 5th level. INT is spellcasting ability | MToF p.23"},
 {id:"sr_tief_zari", title:"Zariel Tiefling", category:"Subrace", phb:true, tags:"tiefling,fire,martial", desc:"Tieflings with a blood tie to Zariel are stronger than typical tieflings and receive magical abilities related to fire.", notes:"ASI: +1 STR, +2 CHA | Legacy of Avernus: Thaumaturgy cantrip. Searing Smite 1/LR at 3rd level. Branding Smite 1/LR at 5th level. CHA is spellcasting ability | MToF p.22"},
 ...
 {id:"sr_duergar", title:"Gray Dwarf (Duergar)", category:"Subrace", phb:false, tags:"dwarf,underdark,psionic,SCAG", desc:"The gray dwarves, or duergar, live deep in the Underdark. They're known for their dour attitudes and their magical abilities.", notes:"ASI: +1 STR | Superior Darkvision: 120ft | Extra Language: Undercommon | Duergar Resilience: Advantage on saves vs illusions and vs charmed/paralyzed | Duergar Magic: Enlarge (self, no concentration) 1/LR at 3rd level, Invisibility (self) 1/LR at 5th level. INT is spellcasting ability | Sunlight Sensitivity: Disadvantage on attack rolls and Perception checks in direct sunlight | MToF p.81"},
 {id:"sr_deepgnome", title:"Deep Gnome (Svirfneblin)", category:"Subrace", phb:false, tags:"gnome,underdark,stealth,SCAG", desc:"The deep gnomes, or svirfneblin, live deep in the Underdark with a tight-knit community.", notes:"ASI: +1 DEX | Superior Darkvision: 120ft | Stone Camouflage: Advantage on Stealth checks to hide in rocky terrain | Extra Language: Undercommon | MToF p.113"},
...
function App() {
 ...
 const popupDesc = [afterColon,trait.desc].filter(Boolean).join(" — ");
 return (
 ...
 return (
              <div className="ft-lib-entry">
                ...
                {entry?.notes&&<NoteTags notes={entry.notes} traits={traits||spc?.traits} extra={cantripExtra} exclude={["Languages"]}/>}
