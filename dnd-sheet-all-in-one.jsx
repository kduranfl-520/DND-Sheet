...
function App() {
 ...
 return (
                  <div key={k} className={`ab-stat-card ${isPri?"ab-stat-primary":""}`} style={(char.species==="Half-Elf"&&(char.halfElfBonusStats||[]).includes(k))?{borderColor:"rgba(34,197,94,0.45)"}:{}}>
                    ...
                    <div className="ab-stat-body">
                      ...
                      <div className={`ab-stat-pill ${isPri?"ab-stat-pill-primary":""}`} style={(char.species==="Half-Elf"&&(char.halfElfBonusStats||[]).includes(k))?{background:"rgba(34,197,94,0.1)",border:"1px solid rgba(34,197,94,0.4)"}:{}}>
