...
function App() {
 ...
 const Empty = ({icon,msg}) => <div className="empty-state"><div style={{fontSize:32,marginBottom:8}}>{icon}</div>{msg}</div>;
  ...
  // RENDER
 return (
    <div className="sheet" style={darkMode?{
 "--bg":"#0f1117","--surface":"#16191f","--card":"#1e2128","--input":"#1e2128",
 "--border":"#2e3340","--border-focus":"#818cf8","--text":"#e2e8f0","--muted":"#94a3b8",
 "--subtle":"#64748b","--divider":"#2e3340",
 }:{}}>
      <style>{CSS}</style>
