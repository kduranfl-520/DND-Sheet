...
window.DND_LIBRARY = {
 ...
 LIB_SEED: [
 {id:"rc_dragonborn", title:"Dragonborn", category:"Race", phb:true, tags:"dragon,breath", desc:"Dragonborn look very much like dragons standing erect in humanoid form, though they lack wings or a tail.", notes:"ASI: +2 STR, +1 CHA | Speed: 30ft | Size: Medium | Darkvision: No | Draconic Ancestry: Choose one dragon type (determines breath weapon element and damage resistance) | Breath Weapon: 2d6 damage in 15ft cone or 5x30ft line (DEX or CON save DC 8+prof+CON), scales to 3d6 at 6th, 4d6 at 11th, 5d6 at 16th | Damage Resistance: Type matching ancestry | Languages: Common, Draconic"},
 {id:"rc_dwarf", title:"Dwarf", category:"Race", phb:true, tags:"hardy,stonecunning", desc:"Bold and hardy, dwarves are known as skilled warriors, miners, and workers of stone and metal.", notes:"ASI: +2 CON | Speed: 25ft (not reduced by heavy armor) | Size: Medium | Darkvision: 60ft | Dwarven Resilience: Advantage on saves vs poison, resistance to poison damage | Dwarven Combat Training: Prof with battleaxe, handaxe, light hammer, warhammer | Tool Proficiency: One of Smith's, Brewer's, or Mason's tools | Stonecunning: Double prof bonus on History checks for stonework | Languages: Common, Dwarvish"},
 {id:"rc_elf", title:"Elf", category:"Race", phb:true, tags:"fey,trance", desc:"Elves are a magical people of otherworldly grace, living in the world but not entirely part of it.", notes:"ASI: +2 DEX | Speed: 30ft | Size: Medium | Darkvision: 60ft | Keen Senses: Perception proficiency | Fey Ancestry: Advantage vs charmed, immune to magic sleep | Trance: 4 hours meditation instead of 8 hours sleep | Languages: Common, Elvish"},
 {id:"rc_gnome", title:"Gnome", category:"Race", phb:true, tags:"cunning,small", desc:"A gnome's energy and enthusiasm for living shines through every inch of his or her tiny body.", notes:"ASI: +2 INT | Speed: 25ft | Size: Small | Darkvision: 60ft | Gnome Cunning: Advantage on all INT/WIS/CHA saving throws against magic | Languages: Common, Gnomish"},
 {id:"rc_halfelf", title:"Half-Elf", category:"Race", phb:true, tags:"versatile,fey", desc:"Walking in two worlds but truly belonging to neither, half-elves combine what some say are the best qualities of their elf and human parents.", notes:"ASI: +2 CHA, +1 to two other ability scores (player choice) | Speed: 30ft | Size: Medium | Darkvision: 60ft | Fey Ancestry: Advantage vs charmed, immune to magic sleep | Skill Versatility: Proficiency in two skills of your choice | Languages: Common, Elvish, one extra language"},
 {id:"rc_halfling", title:"Halfling", category:"Race", phb:true, tags:"lucky,brave,small", desc:"The comforts of home are the goals of most halflings' lives: a place to settle in peace and quiet, far from marauding monsters and clashing armies.", notes:"ASI: +2 DEX | Speed: 25ft | Size: Small | Darkvision: No | Lucky: When you roll a 1 on attack, ability check, or save, reroll and use the new roll | Brave: Advantage on saves vs frightened | Halfling Nimbleness: Move through space of any creature one size larger | Languages: Common, Halfling"},
 {id:"rc_halforc", title:"Half-Orc", category:"Race", phb:true, tags:"savage,relentless", desc:"Whether united under the leadership of a mighty warlock or having fought without anyone to piece things together, half-orcs' bloodlines reach many corners of the world.", notes:"ASI: +2 STR, +1 CON | Speed: 30ft | Size: Medium | Darkvision: 60ft | Menacing: Proficiency in Intimidation | Relentless Endurance: When reduced to 0 HP (not killed outright), drop to 1 HP instead. 1/LR | Savage Attacks: On critical hit with melee weapon, roll one extra weapon damage die | Languages: Common, Orc"},
 {id:"rc_human", title:"Human", category:"Race", phb:true, tags:"versatile,adaptable", desc:"In the reckonings of most worlds, humans are the youngest of the common races, late to arrive on the world scene and short-lived in comparison to dwarves, elves, and dragons.", notes:"ASI: +1 to all six ability scores | Speed: 30ft | Size: Medium | Darkvision: No | Extra Language: One additional language of your choice | Extra Skill: Proficiency in one additional skill (Variant Human only) | Feat: One feat at 1st level (Variant Human only) | Languages: Common, one extra"},
 {id:"rc_tiefling", title:"Tiefling", category:"Race", phb:true, tags:"fiend,hellish", desc:"To be greeted with stares and whispers, to suffer violence and insult on the street, to see mistrust and fear in every eye: this is the lot of the tiefling.", notes:"ASI: +2 CHA, +1 INT | Speed: 30ft | Size: Medium | Darkvision: 60ft | Hellish Resistance: Resistance to fire damage | Infernal Legacy: Know Thaumaturgy cantrip. At 3rd level cast Hellish Rebuke 1/LR. At 5th level cast Darkness 1/LR. Uses CHA as spellcasting ability | Languages: Common, Infernal"},
 {id:"rc_orc", title:"Orc", category:"Race", phb:true, tags:"powerful,relentless,PHB2024", desc:"Orcs are one of Exandria's youngest races, and are said to have been born from elves seared by the light of the sun god Corellon.", notes:"ASI: +2 STR, +1 CON | Speed: 30ft | Size: Medium | Darkvision: 60ft | Aggressive: As a bonus action, move up to your speed toward a hostile creature you can see | Menacing: Proficiency in Intimidation | Powerful Build: Count as one size larger for carrying capacity and push/drag/lift | Languages: Common, Orc"},
 {id:"sr_hilldwarf", title:"Hill Dwarf", category:"Subrace", phb:true, tags:"dwarf,wisdom", desc:"As a hill dwarf, you have keen senses, deep intuition, and remarkable resilience.", notes:"Parent Race: Dwarf | ASI: +1 WIS | Dwarven Toughness: HP maximum increases by 1, and increases by 1 again every time you gain a level | PHB p.20"},
 {id:"sr_mountaindwarf",title:"Mountain Dwarf", category:"Subrace", phb:true, tags:"dwarf,armor", desc:"As a mountain dwarf, you're strong and hardy, acclimated to a difficult life in rugged terrain.", notes:"Parent Race: Dwarf | ASI: +2 STR | Dwarven Armor Training: Proficiency with light and medium armor | PHB p.20"},
 {id:"sr_highelf", title:"High Elf", category:"Subrace", phb:true, tags:"elf,magic", desc:"As a high elf, you have a keen mind and a mastery over at least the basics of magic.", notes:"Parent Race: Elf | ASI: +1 INT | Elf Weapon Training: Proficiency with longsword, shortsword, shortbow, and longbow | Cantrip: Learn one wizard cantrip of your choice (INT is spellcasting ability) | Extra Language: One additional language of your choice | PHB p.23"},
 {id:"sr_woodelf", title:"Wood Elf", category:"Subrace", phb:true, tags:"elf,nature", desc:"As a wood elf, you have keen senses and intuition, and your fleet feet carry you quickly through your native forests.", notes:"Parent Race: Elf | ASI: +1 WIS | Elf Weapon Training: Proficiency with longsword, shortsword, shortbow, and longbow | Fleet of Foot: Speed increases to 35ft | Mask of the Wild: Can attempt to hide when only lightly obscured by natural phenomena | PHB p.24"},
 {id:"sr_drow", title:"Dark Elf (Drow)", category:"Subrace", phb:true, tags:"elf,underdark", desc:"Descended from an earlier subrace of dark-skinned elves, the drow were banished from the surface world for following the goddess Lolth.", notes:"Parent Race: Elf | ASI: +1 CHA | Superior Darkvision: 120ft | Sunlight Sensitivity: Disadvantage on attack rolls and Perception checks in direct sunlight | Drow Magic: Dancing Lights cantrip. Faerie Fire 1/LR at 3rd level. Darkness 1/LR at 5th level. CHA is spellcasting ability | Drow Weapon Training: Proficiency with rapiers, shortswords, and hand crossbows | PHB p.24"},
 {id:"sr_lightfoot", title:"Lightfoot Halfling", category:"Subrace", phb:true, tags:"halfling,stealth", desc:"As a lightfoot halfling, you can easily hide from notice, even using other people as cover.", notes:"Parent Race: Halfling | ASI: +1 CHA | Naturally Stealthy: Can attempt to hide even when only obscured by a creature at least one size larger | PHB p.28"},
 {id:"sr_stout", title:"Stout Halfling", category:"Subrace", phb:true, tags:"halfling,tough", desc:"As a stout halfling, you're hardier than average and have some resistance to poison.", notes:"Parent Race: Halfling | ASI: +1 CON | Stout Resilience: Advantage on saving throws against poison, and resistance to poison damage | PHB p.28"},
 {id:"sr_forestgnome", title:"Forest Gnome", category:"Subrace", phb:true, tags:"gnome,illusion", desc:"As a forest gnome, you have a natural knack for illusion and inherent quickness and stealth.", notes:"Parent Race: Gnome | ASI: +1 DEX | Natural Illusionist: Know Minor Illusion cantrip (INT is spellcasting ability) | Speak with Small Beasts: Communicate simple ideas with Small or smaller beasts through sounds and gestures | PHB p.37"},
 {id:"sr_rockgnome", title:"Rock Gnome", category:"Subrace", phb:true, tags:"gnome,tinker", desc:"As a rock gnome, you have a natural inventiveness and hardiness beyond that of other gnomes.", notes:"Parent Race: Gnome | ASI: +1 CON | Artificer's Lore: Double proficiency bonus on History checks related to magic items, alchemical objects, or technological devices | Tinker: Proficiency with tinker's tools. Construct Tiny clockwork devices (10gp, 1 hour) | PHB p.37"},
 {id:"sr_db_black", title:"Dragonborn - Black", category:"Subrace", phb:true, tags:"dragonborn,acid", desc:"Black dragonborn carry the legacy of the Black Dragon — acid, cunning, and cruelty.", notes:"Parent Race: Dragonborn | Dragon Type: Black | Damage Type: Acid | Breath Weapon: 5x30ft line, DEX save | Damage Resistance: Acid | PHB p.34"},
 {id:"sr_db_blue", title:"Dragonborn - Blue", category:"Subrace", phb:true, tags:"dragonborn,lightning", desc:"Blue dragonborn carry the legacy of the Blue Dragon — lightning and desert storms.", notes:"Parent Race: Dragonborn | Dragon Type: Blue | Damage Type: Lightning | Breath Weapon: 5x30ft line, DEX save | Damage Resistance: Lightning | PHB p.34"},
 {id:"sr_db_brass", title:"Dragonborn - Brass", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Brass dragonborn carry the legacy of the Brass Dragon — fire and conversation.", notes:"Parent Race: Dragonborn | Dragon Type: Brass | Damage Type: Fire | Breath Weapon: 5x30ft line, DEX save | Damage Resistance: Fire | PHB p.34"},
 ...
 {id:"sr_db_copper", title:"Dragonborn - Copper", category:"Subrace", phb:true, tags:"dragonborn,acid", desc:"Copper dragonborn carry the legacy of the Copper Dragon — acid and mischief.", notes:"Parent Race: Dragonborn | Dragon Type: Copper | Damage Type: Acid | Breath Weapon: 5x30ft line, DEX save | Damage Resistance: Acid | PHB p.34"},
 {id:"sr_db_gold", title:"Dragonborn - Gold", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Gold dragonborn carry the legacy of the Gold Dragon — fire and nobility.", notes:"Parent Race: Dragonborn | Dragon Type: Gold | Damage Type: Fire | Breath Weapon: 15ft cone, DEX save | Damage Resistance: Fire | PHB p.34"},
 {id:"sr_db_green", title:"Dragonborn - Green", category:"Subrace", phb:true, tags:"dragonborn,poison", desc:"Green dragonborn carry the legacy of the Green Dragon — poison and deception.", notes:"Parent Race: Dragonborn | Dragon Type: Green | Damage Type: Poison | Breath Weapon: 15ft cone, CON save | Damage Resistance: Poison | PHB p.34"},
 {id:"sr_db_red", title:"Dragonborn - Red", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Red dragonborn carry the legacy of the Red Dragon — fire and dominance.", notes:"Parent Race: Dragonborn | Dragon Type: Red | Damage Type: Fire | Breath Weapon: 15ft cone, DEX save | Damage Resistance: Fire | PHB p.34"},
 {id:"sr_db_silver", title:"Dragonborn - Silver", category:"Subrace", phb:true, tags:"dragonborn,cold", desc:"Silver dragonborn carry the legacy of the Silver Dragon — cold and heroism.", notes:"Parent Race: Dragonborn | Dragon Type: Silver | Damage Type: Cold | Breath Weapon: 15ft cone, CON save | Damage Resistance: Cold | PHB p.34"},
 {id:"sr_db_white", title:"Dragonborn - White", category:"Subrace", phb:true, tags:"dragonborn,cold", desc:"White dragonborn carry the legacy of the White Dragon — cold and savagery.", notes:"Parent Race: Dragonborn | Dragon Type: White | Damage Type: Cold | Breath Weapon: 15ft cone, CON save | Damage Resistance: Cold | PHB p.34"},
 {id:"sr_tief_asmo", title:"Asmodeus Tiefling", category:"Subrace", phb:true, tags:"tiefling,infernal,fire", desc:"The tieflings connected to Nessus, the deepest layer of the Nine Hells, command the power of fire and darkness guided by Asmodeus.", notes:"Parent Race: Tiefling | ASI: +1 INT, +2 CHA | Infernal Legacy: Thaumaturgy cantrip. Hellish Rebuke 1/LR at 3rd level. Darkness 1/LR at 5th level. CHA is spellcasting ability | PHB p.43 / MToF p.21"},
 {id:"sr_tief_meph", title:"Mephistopheles Tiefling",category:"Subrace",phb:true,tags:"tiefling,cold,arcane", desc:"Tieflings with a blood tie to Mephistopheles are gifted with a particular flair for arcane magic.", notes:"Parent Race: Tiefling | ASI: +1 INT, +2 CHA | Legacy of Cania: Mage Hand cantrip. Burning Hands 1/LR at 3rd level. Flame Blade 1/LR at 5th level. INT is spellcasting ability | MToF p.23"},
 {id:"sr_tief_zari", title:"Zariel Tiefling", category:"Subrace", phb:true, tags:"tiefling,fire,martial", desc:"Tieflings with a blood tie to Zariel are stronger than typical tieflings and receive magical abilities related to fire.", notes:"Parent Race: Tiefling | ASI: +1 STR, +2 CHA | Legacy of Avernus: Thaumaturgy cantrip. Searing Smite 1/LR at 3rd level. Branding Smite 1/LR at 5th level. CHA is spellcasting ability | MToF p.22"},
 ...
 {id:"sr_duergar", title:"Gray Dwarf (Duergar)", category:"Subrace", phb:false, tags:"dwarf,underdark,psionic,SCAG", desc:"The gray dwarves, or duergar, live deep in the Underdark. They're known for their dour attitudes and their magical abilities.", notes:"Parent Race: Dwarf | ASI: +1 STR | Superior Darkvision: 120ft | Extra Language: Undercommon | Duergar Resilience: Advantage on saves vs illusions and vs charmed/paralyzed | Duergar Magic: Enlarge (self, no concentration) 1/LR at 3rd level, Invisibility (self) 1/LR at 5th level. INT is spellcasting ability | Sunlight Sensitivity: Disadvantage on attack rolls and Perception checks in direct sunlight | MToF p.81"},
 {id:"sr_deepgnome", title:"Deep Gnome (Svirfneblin)", category:"Subrace", phb:false, tags:"gnome,underdark,stealth,SCAG", desc:"The deep gnomes, or svirfneblin, live deep in the Underdark with a tight-knit community.", notes:"Parent Race: Gnome | ASI: +1 DEX | Superior Darkvision: 120ft | Stone Camouflage: Advantage on Stealth checks to hide in rocky terrain | Extra Language: Undercommon | MToF p.113"},
...
function App() {
 ...
 feat.toLowerCase().startsWith(e.title.toLowerCase())) &&
                            ...
                            e.title.toLowerCase()===feat.toLowerCase() &&
                            (e.category==="CL Feature"||e.category==="Feat"||e.category==="Class")
                          );
