...
window.DND_LIBRARY = {
 ...
 LIB_CATS: ["Race","Subrace","Class","Subclass","CL Feature","Background","Feat","Armor","Shield","Weapon","Equipment","Tools & Kits","Magic Item","Potion","Scroll","Wand & Rod","Gem","Jewelry","Spell","Component","Deity","Faction","Companion","Other"],
 LIB_SEED: [
 ...
 {id:"sp_bane", title:"Bane", category:"Spell",phb:true,tags:"1st,enchantment,PHB", desc:"Up to three creatures of your choice must subtract 1d4 from attack rolls and saving throws for the duration.", notes:"School: Enchantment | Level: 1st | Casting Time: 1 Action | Range: 30ft | Components: V, S, M (a drop of blood) | Duration: Concentration, up to 1 minute | Save: CHA save or affected | Upcast: +1 creature per spell level above 1st."},
