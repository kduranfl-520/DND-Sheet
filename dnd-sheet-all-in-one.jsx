...
window.DND_LIBRARY = {
 ...
 {id:"sr_hilldwarf", title:"Hill Dwarf", category:"Subrace", phb:true, tags:"dwarf,wisdom", desc:"As a hill dwarf, you have keen senses, deep intuition, and remarkable resilience.", notes:"ASI: +1 WIS | Dwarven Toughness: HP maximum increases by 1, and increases by 1 again every time you gain a level"},
 {id:"sr_mountaindwarf",title:"Mountain Dwarf", category:"Subrace", phb:true, tags:"dwarf,armor", desc:"As a mountain dwarf, you're strong and hardy, acclimated to a difficult life in rugged terrain.", notes:"ASI: +2 STR | Dwarven Armor Training: Proficiency with light and medium armor"},
 ...
 {id:"sr_lightfoot", title:"Lightfoot Halfling", category:"Subrace", phb:true, tags:"halfling,stealth", desc:"As a lightfoot halfling, you can easily hide from notice, even using other people as cover.", notes:"ASI: +1 CHA | Naturally Stealthy: Can attempt to hide even when only obscured by a creature at least one size larger"},
 {id:"sr_stout", title:"Stout Halfling", category:"Subrace", phb:true, tags:"halfling,tough", desc:"As a stout halfling, you're hardier than average and have some resistance to poison.", notes:"ASI: +1 CON | Stout Resilience: Advantage on saving throws against poison, and resistance to poison damage"},
 ...
 {id:"sr_db_gold", title:"Dragonborn - Gold", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Gold dragonborn carry the legacy of the Gold Dragon — fire and nobility.", notes:"Dragon Type: Gold | Damage Type: Fire | Breath Weapon: 15ft cone, DEX save DC 8+prof+CON, 2d6 fire (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Fire"},
 {id:"sr_db_green", title:"Dragonborn - Green", category:"Subrace", phb:true, tags:"dragonborn,poison", desc:"Green dragonborn carry the legacy of the Green Dragon — poison and deception.", notes:"Dragon Type: Green | Damage Type: Poison | Breath Weapon: 15ft cone, CON save DC 8+prof+CON, 2d6 poison (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Poison"},
 {id:"sr_db_red", title:"Dragonborn - Red", category:"Subrace", phb:true, tags:"dragonborn,fire", desc:"Red dragonborn carry the legacy of the Red Dragon — fire and dominance.", notes:"Dragon Type: Red | Damage Type: Fire | Breath Weapon: 15ft cone, DEX save DC 8+prof+CON, 2d6 fire (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Fire"},
 {id:"sr_db_silver", title:"Dragonborn - Silver", category:"Subrace", phb:true, tags:"dragonborn,cold", desc:"Silver dragonborn carry the legacy of the Silver Dragon — cold and heroism.", notes:"Dragon Type: Silver | Damage Type: Cold | Breath Weapon: 15ft cone, CON save DC 8+prof+CON, 2d6 cold (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Cold"},
 {id:"sr_db_white", title:"Dragonborn - White", category:"Subrace", phb:true, tags:"dragonborn,cold", desc:"White dragonborn carry the legacy of the White Dragon — cold and savagery.", notes:"Dragon Type: White | Damage Type: Cold | Breath Weapon: 15ft cone, CON save DC 8+prof+CON, 2d6 cold (scales 3d6 at 6th, 4d6 at 11th, 5d6 at 16th)| Damage Resistance: Cold"},
 ...
 {id:"sr_tief_meph", title:"Mephistopheles Tiefling",category:"Subrace",phb:true,tags:"tiefling,cold,arcane", desc:"Tieflings with a blood tie to Mephistopheles are gifted with a particular flair for arcane magic.", notes:"ASI: +1 INT, +2 CHA | Legacy of Cania: Mage Hand cantrip. Burning Hands 1/LR at 3rd level. Flame Blade 1/LR at 5th level. INT is spellcasting ability"},
 ...
 {id:"sr_deepgnome", title:"Deep Gnome (Svirfneblin)", category:"Subrace", phb:false, tags:"gnome,underdark,stealth,SCAG", desc:"The deep gnomes, or svirfneblin, live deep in the Underdark with a tight-knit community.", notes:"ASI: +1 DEX | Superior Darkvision: 120ft | Stone Camouflage: Advantage on Stealth checks to hide in rocky terrain | Extra Language: Undercommon"},
...
function App() {
 ...
 setF("deathSaves.successes", 0);
 setF("deathSaves.failures", 0);
 setCharSaving(p=>({...p, spellSlotsUsed: Array(9).fill(0), inspirationActive: false, breathWeaponUsed: false}));
                    }}>
                    <div>
 ...
 const dbBreathMatch = dbEntry?.notes?.match(/Breath Weapon: ([^|]+)/);
 const breathExtra = isDbSubrace&&dbBreathMatch?(()=>{
 const bwDetail = dbBreathMatch[1].trim();
 ...
 return (
                                    <div style={{marginTop:10,display:"flex",flexDirection:"column",gap:8}}>
                                      <div style={{fontSize:11,fontWeight:700,color:"var(--text)",display:"flex",alignItems:"center",gap:6}}>
                                        <button title={char.breathWeaponUsed?"Used — rest to recover":"Available"} style={{width:14,height:14,borderRadius:"50%",border:"2px solid",flexShrink:0,cursor:"pointer",background:char.breathWeaponUsed?"var(--input)":"rgba(34,197,94,0.2)",borderColor:char.breathWeaponUsed?"var(--border)":"var(--green)",padding:0}} onClick={()=>setF("breathWeaponUsed",!char.breathWeaponUsed)}/>
                                        Breath Weapon
 ...
 onClick={e=>{e.stopPropagation();setWearingInfo(wearingInfo===infoKey?null:infoKey);}}>i</span>
                                      ...
                                      <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                                        <div style={{display:"flex",flexDirection:"column",gap:3,flex:1,minWidth:80}}>
                                          ...
                                          <div style={{fontFamily:"'DM Mono',monospace",fontSize:20,fontWeight:900,color:"var(--accent)",background:"rgba(99,102,241,0.08)",border:"1px solid rgba(99,102,241,0.2)",borderRadius:8,padding:"4px 10px",textAlign:"center"}}>{dc}</div>
                                        </div>
                                        <div style={{display:"flex",flexDirection:"column",gap:3,flex:1,minWidth:80}}>
                                          <div style={{fontSize:9,fontWeight:700,letterSpacing:".07em",textTransform:"uppercase",color:"var(--muted)"}}>Damage</div>
                                          <button style={{fontFamily:"'DM Mono',monospace",fontSize:16,fontWeight:800,color:"var(--red)",background:"rgba(239,68,68,0.08)",border:"1px solid rgba(239,68,68,0.25)",borderRadius:8,padding:"4px 10px",cursor:"pointer",fontFamily:"inherit"}}
 onClick={()=>{
 const [num,die]=dmgDice.split("d").map(Number);
 let total=0;for(let i=0;i<num;i++)total+=Math.floor(Math.random()*die)+1;
 rollCheck("Breath Weapon",total);
                                            }}>{dmgDice} ▶</button>
                                        </div>
                                      </div>
                                    </div>
