...
function App() {
 ...
 (trait.name.toLowerCase()==="dwarven toughness"&&char.subrace==="Hill Dwarf") ||
 (trait.name.toLowerCase()==="dwarven resilience"&&char.species==="Dwarf") ||
 (trait.name.toLowerCase()==="dwarven armor training"&&char.subrace==="Mountain Dwarf") ||
