 ...
 return (
  ...
  "Entertainer's Pack": "Entertainer's Pack\nBackpack, bedroll, 2 costumes, 5 candles, 5 rations, waterskin, disguise kit.",
                                                      ...
                                                      if(packKey){
                                                        ...
                                                        else if(newStarterPack===PACK_CONTENTS[packKey]){ newStarterPack = ""; }
                                                      }
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:8}}>
                {(()=>{
                  ...
                  const packItems = itemStr ? itemStr.split(",").map(s=>s.trim()).filter(Boolean) : [];
                  return (
                    <div className="card-wrap" style={{padding:"10px 12px",marginBottom:0}}>
                      ...
                      {packItems.length>0&&<div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                        {packItems.map((item,i)=>(
                          <span key={i} style={{fontSize:10,fontWeight:500,padding:"2px 8px",borderRadius:5,background:"var(--input)",border:"1px solid var(--border)",color:"var(--text)",whiteSpace:"nowrap"}}>{item}</span>
                        ))}
                      </div>}
                    </div>
                  );
