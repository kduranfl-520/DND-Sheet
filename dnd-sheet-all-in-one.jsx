...
function App() {
 ...
 style={isClass?{background:"rgba(99,102,241,0.08)",borderRadius:5,outline:"1px solid rgba(99,102,241,0.2)"}:isBg?{background:"rgba(59,130,246,0.08)",borderRadius:5,outline:"1px solid rgba(59,130,246,0.2)"}:{}}
