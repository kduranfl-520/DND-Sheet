...
function App() {
 ...
 onChange={e=>updateMi({name:e.target.value})}>
                          ...
                          {(()=>{
                            ...
                            const inWearingSlot =
                              t.includes("helm")||t.includes("hat")||t.includes("crown")||t.includes("circlet")||t.includes("hood")||(t.includes("eye")&&!t.includes("robe"))||t.includes("goggle")||  // head
                              t.includes("necklace")||t.includes("amulet")||t.includes("pendant")||t.includes("medallion")||t.includes("periapt")||t.includes("scarab")||  // neck
                              t.includes("cloak")||t.includes("cape")||t.includes("mantle")||  // shoulders
                              t.includes("robe")||t.includes("armor of")||  // body
                              (t.includes("tattoo"))||  // skin
                              t.includes("bracer")||t.includes("armband")||t.includes("band of ")||  // arms
                              t.includes("gauntlet")||t.includes("glove")||  // hands
                              t.includes("belt")||t.includes("girdle")||  // hips
                              t.includes("boot")||t.includes("slipper")||t.includes("sandal");  // feet
                            return libEntries.filter(e=>e.category==="Magic Item"&&!inWearingSlot&&(!wornNamesLower.has(e.title.toLowerCase())||e.title===miName)).sort((a,b)=>a.title.localeCompare(b.title)).map(e=>(
                              <option key={e.id} value={e.title}>{e.title}</option>
                            ));
                          })()}
                        </select>
