...
function App() {
 ...
 rollCheck("Breath Weapon",total);
                                            }}>{(()=>{const [num]=dmgDice.split("d");return(<span style={{display:"flex",alignItems:"center",justifyContent:"center",gap:4,fontFamily:"'DM Mono',monospace"}}>{dmgDice}<svg viewBox="0 0 18 18" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"><rect x="1" y="1" width="16" height="16" rx="3"/><circle cx="5.5" cy="5.5" r="1.2" fill="currentColor" stroke="none"/><circle cx="12.5" cy="5.5" r="1.2" fill="currentColor" stroke="none"/><circle cx="5.5" cy="9" r="1.2" fill="currentColor" stroke="none"/><circle cx="12.5" cy="9" r="1.2" fill="currentColor" stroke="none"/><circle cx="5.5" cy="12.5" r="1.2" fill="currentColor" stroke="none"/><circle cx="12.5" cy="12.5" r="1.2" fill="currentColor" stroke="none"/></svg>▶</span>);})()}</button>
                                        </div>
                                      </div>
                                    </div>
                                  );
