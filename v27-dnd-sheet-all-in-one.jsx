...
function App() {
 ...
 onClick={()=>setCharSaving(p=>{const a=[...(p.weaponItems||[])];a.splice(idx,1);return {...p,weaponItems:a};})}>✕</button>
            ...
            {(()=>{
              ...
              const opts_wearing_head = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("helm")||e.title.toLowerCase().includes("hat")||e.title.toLowerCase().includes("head")||e.title.toLowerCase().includes("crown")||e.title.toLowerCase().includes("circlet")||e.title.toLowerCase().includes("hood"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_arms = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("arm")||e.title.toLowerCase().includes("bracer")||e.title.toLowerCase().includes("sleeve")||e.title.toLowerCase().includes("gauntlet")||e.title.toLowerCase().includes("vambrace"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_feet = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("boot")||e.title.toLowerCase().includes("slipper")||e.title.toLowerCase().includes("shoe")||e.title.toLowerCase().includes("feet")||e.title.toLowerCase().includes("sandal"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
