...
function App() {
 ...
 onChange={e=>changeAbility(k,e.target.value)}/>
                          {bonus!==0&&<span style={{fontSize:10,fontWeight:700,color:"var(--green)",fontFamily:"'DM Mono',monospace"}}>({eff[k]})</span>}
                        </div>
                        {bonus!==0&&(
