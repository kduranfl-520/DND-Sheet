...
function App() {
 ...
 const rolls=[];for(let i=0;i<num;i++)rolls.push(Math.floor(Math.random()*die)+1);
 const total=rolls.reduce((a,b)=>a+b,0);
 setSkillRoll({label:"Breath Weapon ("+dmgDice+")",roll:total,bonus:0,total,isCrit:false,isFail:false,sides:die,r1:total,r2:null,isAdv:false,isDis:false});
