...
const BLANK = {
 ...
 languages:[],
 divineDomain:"",
 racialCantrip:"", racialToolProf:"", halfElfBonusStats:[], variantHumanSkill:"", variantHumanFeat:"", charHeight:"", charWeight:"", charAge:"", charSkin:"", charHair:"", charEyes:"",
};
...
function App() {
 ...
 const varHumanSkill = (char.subrace==="Human (Variant)"&&char.variantHumanSkill)?[char.variantHumanSkill]:[];
  const effSkillProfs = [...new Set([...(char.skillProficiencies||[]), ...bgSkills, ...raceSkills, ...(char.classSkills||[]), ...varHumanSkill])];
 ...
 const isRace  = raceSkills.includes(sk.name) && !isBg;
