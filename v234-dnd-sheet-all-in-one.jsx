...
function App() {
 ...
 strokeWidth="1.8" strokeLinejoin="round">
              ...
              <div className="iad-card" style={{flexDirection:"row",alignItems:"center",gap:10}}>
                <div className="iad-title" style={{flexShrink:0,marginBottom:0}}>INSPIRATION / ACTION DICE</div>
                <div className="iad-row" style={{flex:1}}>
                  {/* Inspiration toggle */}
