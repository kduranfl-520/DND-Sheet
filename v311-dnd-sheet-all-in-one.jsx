...
window.DND_LIBRARY = {
 ...
 {id:"sr_tief_asmo", title:"Asmodeus Tiefling", category:"Subrace", phb:true, tags:"tiefling,infernal,fire", desc:"The tieflings connected to Nessus, the deepest layer of the Nine Hells, command the power of fire and darkness guided by Asmodeus.", notes:"Parent Race: Tiefling | Ability Score Increase: +1 INT, +2 CHA | Infernal Legacy: Thaumaturgy cantrip. Hellish Rebuke 1/LR at 3rd level. Darkness 1/LR at 5th level. CHA is spellcasting ability | PHB p.43 / MToF p.21"},
