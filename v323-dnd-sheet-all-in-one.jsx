...
function App() {
 ...
 style={{width:52,color:char.subrace==="Wood Elf"?"var(--green)":"var(--text)"}}/>
 ...
 const infoGreenNames = ["keen senses","dwarven resilience","menacing","stout resilience","damage resistance"];
 const traitIsGreen = (
 !infoGreenNames.includes(trait.name.toLowerCase()) &&
