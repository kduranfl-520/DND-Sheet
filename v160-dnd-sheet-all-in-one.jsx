...
window.DND_LIBRARY = {
 ...
 LIB_SEED: [
 {id:"rc_dragonborn", title:"Dragonborn", category:"Race", phb:true, tags:"dragon,breath", desc:"Dragonborn look very much like dragons standing erect in humanoid form, though they lack wings or a tail.", notes:"ASI: +2 STR, +1 CHA | Speed: 30ft | Size: Medium | Darkvision: No | Draconic Ancestry: Choose one dragon type (determines breath weapon element and damage resistance) | Breath Weapon: 2d6 damage in 15ft cone or 5x30ft line (DEX or CON save DC 8+prof+CON), scales to 3d6 at 6th, 4d6 at 11th, 5d6 at 16th | Damage Resistance: Type matching ancestry | Languages: Common, Draconic | Subraces: Chromatic, Metallic, Gem (TCE)"},
 {id:"rc_dwarf", title:"Dwarf", category:"Race", phb:true, tags:"hardy,stonecunning", desc:"Bold and hardy, dwarves are known as skilled warriors, miners, and workers of stone and metal.", notes:"ASI: +2 CON | Speed: 25ft (not reduced by heavy armor) | Size: Medium | Darkvision: 60ft | Dwarven Resilience: Advantage on saves vs poison, resistance to poison damage | Dwarven Combat Training: Prof with battleaxe, handaxe, light hammer, warhammer | Tool Proficiency: One of Smith's, Brewer's, or Mason's tools | Stonecunning: Double prof bonus on History checks for stonework | Languages: Common, Dwarvish | Subraces: Hill Dwarf (+1 WIS, +1 HP/level, Perception prof), Mountain Dwarf (+2 STR, light/medium armor prof)"},
 {id:"rc_elf", title:"Elf", category:"Race", phb:true, tags:"fey,trance", desc:"Elves are a magical people of otherworldly grace, living in the world but not entirely part of it.", notes:"ASI: +2 DEX | Speed: 30ft | Size: Medium | Darkvision: 60ft | Keen Senses: Perception proficiency | Fey Ancestry: Advantage vs charmed, immune to magic sleep | Trance: 4 hours meditation instead of 8 hours sleep | Languages: Common, Elvish | Subraces: High Elf (+1 INT, one wizard cantrip, extra language, longsword/shortsword/longbow/shortbow), Wood Elf (+1 WIS, fleet of foot 35ft, mask of the wild, elf weapon training), Drow/Dark Elf (+1 CHA, 120ft superior darkvision, sunlight sensitivity, drow magic, drow weapon training)"},
 {id:"rc_gnome", title:"Gnome", category:"Race", phb:true, tags:"cunning,small", desc:"A gnome's energy and enthusiasm for living shines through every inch of his or her tiny body.", notes:"ASI: +2 INT | Speed: 25ft | Size: Small | Darkvision: 60ft | Gnome Cunning: Advantage on all INT/WIS/CHA saving throws against magic | Languages: Common, Gnomish | Subraces: Forest Gnome (+1 DEX, Minor Illusion cantrip, speak with small animals), Rock Gnome (+1 CON, Artificer's Lore, tinker prof — construct tiny clockwork devices)"},
