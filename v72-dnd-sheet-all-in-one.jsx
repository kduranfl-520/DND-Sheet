...
function App() {
 ...
 onClick={()=>setCharSaving(p=>{const a=[...(p.weaponItems||[])];a.splice(idx,1);return {...p,weaponItems:a};})}>✕</button>
            ...
            {(()=>{
              ...
              const opts_wearing_head = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("helm")||e.title.toLowerCase().includes("hat")||e.title.toLowerCase().includes("head")||e.title.toLowerCase().includes("crown")||e.title.toLowerCase().includes("circlet")||e.title.toLowerCase().includes("hood")||(e.title.toLowerCase().includes("eye")&&!e.title.toLowerCase().includes("robe"))||e.title.toLowerCase().includes("goggle"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
                  ...
                  {open_wearing_head&&<div style={{padding:"8px 12px",display:"flex",flexDirection:"column",gap:5}}>
                    ...
                    {items_wearing_head.map((item,idx)=>{
                      ...
                      const entry = itemName?libEntries.find(e=>e.title===itemName&&e.category==="Magic Item"):null;
                      ...
                      return (
                        <div key={idx} style={{display:"flex",gap:4,alignItems:"center"}}>
                          ...
                          {itemName&&<input
                            className="gi gi-sm"
                            style={{flex:"1 1 60px",fontSize:11,minWidth:40,maxWidth:120}}
                            placeholder="Notes..."
                            value={item.notes||""}
            ...
            {(()=>{
              ...
              const opts_wearing_neck = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("necklace")||e.title.toLowerCase().includes("amulet")||e.title.toLowerCase().includes("neck")||e.title.toLowerCase().includes("pendant")||e.title.toLowerCase().includes("medallion")||e.title.toLowerCase().includes("periapt")||e.title.toLowerCase().includes("scarab"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_shoulders = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("shoulder")||e.title.toLowerCase().includes("mantle")||e.title.toLowerCase().includes("pauldron")||e.title.toLowerCase().includes("cloak")||e.title.toLowerCase().includes("cape"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_body = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("robe"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_arms = libEntries.filter(e=>e.category==="Magic Item"&&((/\barm\b/i.test(e.title))||e.title.toLowerCase().includes("bracer")||e.title.toLowerCase().includes("sleeve")||e.title.toLowerCase().includes("vambrace"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_hands = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("glove")||e.title.toLowerCase().includes("gauntlet")||(/\bhand\b/i.test(e.title))||(/\bring\b/i.test(e.title))||e.title.toLowerCase().includes("mitten"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_hips = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("belt")||e.title.toLowerCase().includes("girdle")||(/\bhip\b/i.test(e.title)))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
            ...
            {(()=>{
              ...
              const opts_wearing_feet = libEntries.filter(e=>e.category==="Magic Item"&&(e.title.toLowerCase().includes("boot")||e.title.toLowerCase().includes("slipper")||(/\bshoe\b/i.test(e.title))||e.title.toLowerCase().includes("sandal"))).sort((a,b)=>a.title.localeCompare(b.title));
              return (
                <div className="card-wrap" style={{marginBottom:8,padding:0,overflow:"hidden"}}>
 ...
 onChange={e=>updateMi({name:e.target.value})}>
                          ...
                          {(()=>{
                            const wornNames = new Set([
                              ...
                              ...(char.wearing_arms||[]), ...(char.wearing_hands||[]),
                              ...(char.wearing_hips||[]), ...(char.wearing_feet||[]),
                            ].map(i=>typeof i==="object"?i.name:i).filter(Boolean));
                            return libEntries.filter(e=>e.category==="Magic Item"&&!wornNames.has(e.title)).sort((a,b)=>a.title.localeCompare(b.title)).map(e=>(
                              <option key={e.id} value={e.title}>{e.title}</option>
                            ));
                          })()}
                        </select>
 ...
 onClick={()=>setCharSaving(p=>{const a=[...(p.componentItems||[])];a.splice(idx,1);return {...p,componentItems:a};})}>✕</button>
                ...
                {(()=>{
                  const sbItems = (char.spellbooks||"").split("\n").map(s=>s.trim()).filter(Boolean);
                  return (
                    <div className="card-wrap" style={{padding:"10px 12px",marginBottom:0}}>
                      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:6}}>
                        <div style={{display:"flex",alignItems:"center",gap:5}}>
                        ...
                        <button className="ri-add-btn" style={{padding:"2px 8px",fontSize:10}}
                          onClick={()=>{
                            const name = prompt("Add spellbook or tome:");
                            if(name&&name.trim()) setF("spellbooks",(char.spellbooks||"")+((char.spellbooks||"").trim()?"\n":"")+name.trim());
                          }}>+ Add</button>
                      </div>
                      {sbItems.length===0&&<div style={{fontSize:11,color:"var(--subtle)",fontStyle:"italic"}}>No spellbooks.</div>}
                      <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                        {sbItems.map((sb,i)=>(
                          <span key={i} style={{display:"inline-flex",alignItems:"center",gap:4,fontSize:10,fontWeight:500,padding:"2px 8px",borderRadius:5,background:"var(--input)",border:"1px solid var(--border)",color:"var(--text)"}}>
                            {sb}
                            <button style={{background:"none",border:"none",cursor:"pointer",color:"var(--muted)",fontSize:10,padding:0,lineHeight:1,fontFamily:"inherit"}}
                              onClick={()=>setF("spellbooks",sbItems.filter((_,j)=>j!==i).join("\n"))}>✕</button>
                          </span>
                        ))}
                      </div>
                    </div>
