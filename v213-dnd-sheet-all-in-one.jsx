...
function App() {
 ...
 return (
    <div className="sheet">
      <style>{CSS}</style>
      {darkMode&&<style>{"html,body,.sheet{--bg:#0f1117!important;--surface:#16191f!important;--card:#1e2128!important;--input:#1e2128!important;--border:#2e3340!important;--border-focus:#818cf8!important;--text:#e2e8f0!important;--muted:#94a3b8!important;--subtle:#64748b!important;--divider:#2e3340!important;}"}</style>}
